<header class="topbar">
    ...
    <div class="topbar-right ms-auto d-flex align-items-center gap-3">
        <a class="topbar-icon position-relative enhanced-icon notification-bell" href="{{ route('staff.dashboard') }}" aria-label="Staff dashboard" title="Staff dashboard">
        ...
        <div class="profile-dropdown-wrapper position-relative">
            ...
            <div class="profile-dropdown-menu" id="profileDropdownMenu">
                ...
                <div class="profile-role">Office Staff</div>
                    </div>
                </div>
