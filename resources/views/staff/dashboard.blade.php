...
@section('title', 'Staff Dashboard - D&G Construction Monitor')
    ...
    <div class="top-row-grid">
        ...
        <div class="hero-banner">
            <div class="hero-content">
                ...
                <a href="{{ route('staff.projects.index') }}" class="hero-btn">
        ...
        <div class="quick-actions-card">
            ...
            <div class="qa-grid">
                <a href="{{ route('staff.projects.create') }}" class="qa-item">
                    <div class="qa-icon"><i class="bi bi-file-earmark-plus"></i></div>
                    New<br>Project
                </a>
                <a href="{{ route('staff.inventory') }}" class="qa-item">
                    <div class="qa-icon"><i class="bi bi-box-seam"></i></div>
                    Add<br>Material
                </a>
                <a href="{{ route('staff.attendance') }}" class="qa-item">
                    <div class="qa-icon"><i class="bi bi-person-plus"></i></div>
                    Add<br>Worker
                </a>
                <a href="{{ route('staff.reports.index') }}" class="qa-item">
    ...
    <div class="stats-grid-4">
        ...
        <div class="stat-box">
            ...
            <div class="stat-info">
                ...
                <div class="stat-subtext link"><span style="color:#10b981;">â—</span> On track</div>
            </div>
        </div>
    ...
    <div class="bottom-row-grid">
        ...
        <div class="dash-card">
            <div class="dash-card-header">
                ...
                <a href="{{ route('staff.projects.index') }}" class="dash-card-link">View all projects &rarr;</a>
            </div>
        ...
        <div>
            ...
            <div class="dash-card">
                <div class="dash-card-header">
                    ...
                    <a href="{{ route('staff.reports.index') }}" class="dash-card-link">View all reports &rarr;</a>
                </div>

                <div class="reports-list">
                    @forelse($recentReports ?? [] as $report)
                        <div class="report-list-item" onclick="window.location.href='{{ route('staff.reports.index') }}'" style="cursor: pointer;">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg rounded-4" style="background: #ffffff;">
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-2 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('staff.projects.index') }}" id="viewFullProjectBtn" class="btn btn-success px-4 shadow-sm fw-medium rounded-2 d-flex align-items-center gap-2" style="height: 40px; font-size: 0.88rem; text-decoration: none;">
...
<script>
    function openProjectDetailModal(el) {
        ...
        if (viewFullProjectBtn && projectId) {
            viewFullProjectBtn.href = '/staff/projects';
        }
