...
<script>
    ...
    function buildTablePagination(totalItems, currentPage, tableKey) {
        ...
        const buttons = [
            `<button type="button" class="pagination-button" data-table="${tableKey}" data-page="${previousPage}" ${currentPage === 1 ? 'disabled' : ''} aria-label="Previous page">â€¹</button>`
        ];
        ...
        buttons.push(`<button type="button" class="pagination-button" data-table="${tableKey}" data-page="${nextPage}" ${currentPage === totalPages ? 'disabled' : ''} aria-label="Next page">â€º</button>`);
        return buttons.join('');
    }
