                    ...
                    <div class="modal-body px-4 py-4">
                        ...
                        <div class="alert alert-secondary border-0 bg-light rounded-3 mt-3 mb-0 d-flex gap-2 py-2 px-3">
                            ...
                            <div class="small text-muted mb-0">
                                <strong>Engineer/Administrator</strong> â€” full system access.
                                <strong>Site Supervisor</strong> â€” manages assigned projects.
                                <strong>Client</strong> â€” read-only project visibility.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editUserForm.addEventListener('submit', function (e) {
        ...
        // Password is optional on edit â€” only validate it if the person is
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addUserForm.addEventListener('submit', function (e) {
        ...
        // round trip. The server remains the source of truth â€” these
