                ...
                <div class="card-footer bg-white border-top-0 py-3">
                    <div class="table-pagination-strip">
                        ...
                        <div class="pagination-bar">
                            <a class="pagination-button {{ $phases->onFirstPage() ? 'disabled' : '' }}" href="{{ $phases->previousPageUrl() ?? '#' }}" aria-label="Previous page">â€¹</a>
                            ...
                            @endfor
                            <a class="pagination-button {{ $phases->hasMorePages() ? '' : 'disabled' }}" href="{{ $phases->nextPageUrl() ?? '#' }}" aria-label="Next page">â€º</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function renderPhaseSearchOptions() {
            ...
            const optionMarkup = matches.map((phase) => `
                <button
                    ...
                    role="option"
                >
                    <span class="option-order">${escapeHtml(phase.order || 'â€”')}</span>
            ...
            detailsPanel.innerHTML = `
                ...
                <div class="d-flex flex-column gap-2.5 mb-4" style="font-size: 13px;">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-bold text-dark">${escapeHtml(payload.phase_order || 'â€”')}</span>
                    </div>
                    <div class="d-flex justify-content-between">
        ...
        function updatePhaseRow(phase) {
            try {
                ...
                if (scheduleCells && scheduleCells.length >= 2) {
                    scheduleCells[0].innerHTML = `<span class="schedule-chip"><i class="bi bi-calendar3 me-1"></i> ${phase.planned_start_date || 'â€”'}</span><span class="schedule-separator"><i class="bi bi-arrow-right"></i></span><span class="schedule-chip"><i class="bi bi-calendar3 me-1"></i> ${phase.planned_end_date || 'â€”'}</span>`;
                }
