...
<head>
    ...
    <style>
        ...
        .app {
            display: flex;
            min-height: 100vh;
            background: linear-gradient(180deg, #fffdf3 0%, var(--supervisor-bg) 100%);
        }

        .sidebar {
            width: 280px;
            background: linear-gradient(180deg, #1f5f2a 0%, var(--supervisor-primary) 100%);
            color: #fff;
            position: sticky;
            top: 0;
            height: 100vh;
            overflow-y: auto;
            box-shadow: 4px 0 18px rgba(46, 125, 50, 0.18);
        }
        ...
        .nav-item.active {
            ...
            color: #fff;
            border-left-color: var(--supervisor-highlight);
        }
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('supervisor.reports') }}" class="nav-item {{ request()->routeIs('supervisor.reports') ? 'active' : '' }}">
                <i class="bi bi-file-earmark-text"></i> Report History
            </a>
