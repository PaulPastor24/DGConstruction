                                        ...
                                        <tr data-tool-row="true"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1 inventory-action-stack">
                                                    <?php if($canIssue): ?>
                                                        <button type="button" class="btn btn-sm btn-light p-1 px-2 border text-success bg-white btn-issue-tool" data-tool-id="<?php echo e($tool->id); ?>" data-tool-name="<?php echo e($tool->name); ?>" data-tool-code="<?php echo e($tool->tool_code); ?>" title="Issue tool"><i class="bi bi-arrow-up-right-square"></i> Issue</button>
                                                    <?php endif; ?>
                                                    <?php if($canReturn): ?>
        ...
        <div class="col-lg-3 d-flex flex-column gap-3">
            ...
            <div class="card mi-side-widget border-0 shadow-sm rounded-4 p-3 bg-white">
                ...
                <div class="d-flex justify-content-center mb-3">
                    <div class="position-relative d-flex align-items-center justify-content-center" style="width: 115px; height: 115px; border-radius: 50%; background: conic-gradient(#10b981 0% <?php echo e($metrics['available_percentage']); ?>%, #f97316 <?php echo e($metrics['available_percentage']); ?>% <?php echo e($metrics['available_percentage'] + $metrics['low_stock_percentage']); ?>%, #ef4444 <?php echo e($metrics['available_percentage'] + $metrics['low_stock_percentage']); ?>% 100%);">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        bindModalFormLoading(document.querySelector('#editMaterialModal<?php echo e($material->id); ?> form'));
