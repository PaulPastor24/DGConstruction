<?php $__env->startSection('title', 'Group Attendance - D&G Construction Monitor'); ?>
<?php $__env->startSection('page_title', 'Group Attendance'); ?>

<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/supervisor.css']); ?>
    <style>
...
<div class="container-fluid p-0 attendance-page">
            ...
            <div class="attendance-control-layout">
                ...
                <div class="attendance-action-panel">
                    <div class="attendance-date-field">
                        ...
                        <input id="attendanceDateInput" type="date" name="attendance_date" class="form-control form-control-sm" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
    ...
    <div class="row g-4 attendance-main-grid">
        ...
        <div class="col-12 col-lg-8">
            <form action="<?php echo e(route('supervisor.attendance.save')); ?>" method="POST" id="attendanceMainForm">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\supervisor\attendance.blade.php ENDPATH**/ ?>