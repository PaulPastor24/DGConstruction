<?php $__env->startSection('title', 'Reports - D&G Construction Monitor'); ?>
...
<div id="pg-reports" class="reports-mobile-admin-page">
    ...
    <div class="summary-grid">
        <div class="summary-card total">
            <div class="summary-info">
                ...
                <div class="value"><?php echo e($stats['total'] ?? 0); ?></div>
        ...
        <div class="summary-card pending">
            <div class="summary-info">
                ...
                <div class="value"><?php echo e($stats['pending'] ?? 0); ?></div>
        ...
        <div class="summary-card approved">
            <div class="summary-info">
                ...
                <div class="value"><?php echo e($stats['approved'] ?? 0); ?></div>
        ...
        <div class="summary-card published">
            <div class="summary-info">
                ...
                <div class="value"><?php echo e($stats['published'] ?? 0); ?></div>
        ...
        <div class="summary-card rejected">
            <div class="summary-info">
                ...
                <div class="value"><?php echo e($stats['rejected'] ?? 0); ?></div>
    ...
    <div class="workspace-layout" id="reportsWorkspaceLayout">
        ...
        <div class="workspace-left-col">
            ...
            <div class="top-toolbar">
                <div class="toolbar-group search-group">
                    <input id="reportsSearchInput" type="text" class="toolbar-input" placeholder="Search report title, ID, project, phase, or supervisor..." value="<?php echo e(request('search')); ?>">
                </div>
                ...
                <div class="toolbar-group">
                    <select id="supervisorFilter" class="toolbar-select" name="supervisor_id">
                        ...
                        <?php $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($supervisor->user_id); ?>" <?php echo e(request('supervisor_id') == $supervisor->user_id ? 'selected' : ''); ?>><?php echo e($supervisor->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <?php if(request('project_id')): ?>
                    <div class="toolbar-group">
                        <a href="<?php echo e(route('admin.reports.imagesPdf', request('project_id'))); ?>" class="btn-export" target="_blank">
        ...
        <div class="table-container-card">
            <div class="card-table-header d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="card-table-title" id="reportsListHeading">Reports List (<?php echo e($reports->total()); ?>)</h3>
                    ...
                    <tbody id="reportsTableBody">
                        <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-report-id="<?php echo e($report->report_id); ?>">
                                <td class="cell-bold" data-label="ID"><?php echo e($report->report_id); ?></td>
                                <td data-label="Project"><?php echo e(optional($report->project)->project_name ?? 'Unassigned Project'); ?></td>
                                <td data-label="Phase"><?php echo e(optional($report->phase)->phase_name ?? 'Unassigned Phase'); ?></td>
                                <td data-label="Supervisor">
                                    <div class="user-cell">
                                        <span><?php echo e(optional($report->submittedBy)->name ?? 'Unassigned Supervisor'); ?></span>
                                    </div>
                                </td>
                                <td data-label="Date"><span class="cell-bold"><?php echo e(optional($report->report_date)->format('M d, Y') ?? $report->created_at->format('M d, Y')); ?></span></td>
                                <td data-label="Status">
                                    <span class="status-pill <?php echo e($report->status_badge_class); ?>"><?php echo e($report->status_label); ?></span>
                                </td>
                                <td data-label="Actions">
                                    <div class="action-icons-group">
                                        <button type="button" class="btn-icon-action js-view-report" data-report-id="<?php echo e($report->report_id); ?>" title="View Details"><i class="bi bi-eye"></i></button>
                                        <a href="<?php echo e(route('admin.reports.downloadPdf', $report->report_id)); ?>" class="btn-icon-action" title="Export PDF"><i class="bi bi-download"></i></a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="8" class="text-center py-4">
                                    <?php echo e($reports->count() === 0 ? ($stats['total'] > 0 ? 'No reports match your selected filters.' : 'No accomplishment reports found.') : ''); ?>
            ...
            <div class="table-pagination-strip">
                <div id="reportsPaginationInfo" class="pagination-summary">
                    <?php if($reports->total() > 0): ?>
                        Showing <?php echo e($reports->firstItem()); ?> to <?php echo e($reports->lastItem()); ?> of <?php echo e($reports->total()); ?> reports
                    <?php else: ?>
                        Showing 0 reports
                    <?php endif; ?>
                </div>
                <div id="reportsPagination" class="pagination-bar">
                    <?php if($reports->currentPage() > 1): ?>
                        <button type="button" class="pagination-button" data-page="<?php echo e($reports->currentPage() - 1); ?>" aria-label="Previous page">‹</button>
                    <?php endif; ?>
                    <?php $__currentLoopData = range(1, $reports->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="pagination-button <?php echo e($page == $reports->currentPage() ? 'active' : ''); ?>" data-page="<?php echo e($page); ?>" aria-label="Page <?php echo e($page); ?>"><?php echo e($page); ?></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($reports->hasMorePages()): ?>
                        <button type="button" class="pagination-button" data-page="<?php echo e($reports->currentPage() + 1); ?>" aria-label="Next page">›</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body py-4">
                    <div id="report-details-panel" class="report-details-panel">
                        <?php if($reports->isNotEmpty()): ?>
                            <?php $selectedReport = $reports->first(); ?>
                            <?php
                                    ...
                                    <div class="modal-detail-card">
                                        <div class="d-flex flex-column flex-sm-row justify-content-between gap-3 mb-4 p-3 rounded-3" style="background: #ffffff; border: 1px solid #e8f0eb;">
                                            <div>
                                                ...
                                                <div class="fw-bold text-dark" style="font-size: 1.15rem; color: var(--cms-green-dark);"><?php echo e($reportId); ?></div>
                                            </div>
                                            <div class="text-sm-end">
                                                <div class="modal-section-title mb-1" style="margin-top:0; border:none; padding-bottom:0;">Approval Status</div>
                                                <span class="status-pill <?php echo e($reportStatusClass); ?> p-2 mt-1 d-inline-block"><?php echo e($reportStatusLabel); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-info-grid mb-4">
                                            <div class="modal-info-item">
                                                ...
                                                <div class="modal-info-value"><?php echo e(optional($selectedReport->project)->project_name ?? 'N/A'); ?></div>
                                            </div>
                                            <div class="modal-info-item">
                                                <div class="modal-info-label">Construction Phase</div>
                                                <div class="modal-info-value"><?php echo e(optional($selectedReport->phase)->phase_name ?? 'N/A'); ?></div>
                                            </div>
                                            <div class="modal-info-item">
                                                <div class="modal-info-label">Report Date</div>
                                                <div class="modal-info-value"><?php echo e(optional($selectedReport->report_date)->format('M d, Y') ?? $selectedReport->created_at->format('M d, Y')); ?></div>
                                            </div>
                                            <div class="modal-info-item">
                                                <div class="modal-info-label">Submitted By</div>
                                                <div class="modal-info-value"><?php echo e(optional($selectedReport->submittedBy)->name ?? 'Supervisor'); ?></div>
                                            </div>
                                        </div>

                                        <div class="modal-section-title">Construction Accomplishment</div>
                                        <div class="modal-accomplishment-box mb-4">
                                            <p class="mb-0 text-dark small" style="white-space: pre-line; line-height: 1.7;"><?php echo e($selectedReport->report_text ?? 'No description logs reported.'); ?></p>
                                        </div>
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-12 col-md-6">
                                                <div class="modal-info-item">
                                                    ...
                                                    <div class="modal-info-value"><?php echo e(optional($selectedReport->reviewedBy)->name ?? 'Pending review'); ?></div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="modal-info-item">
                                                    <div class="modal-info-label">Approved By</div>
                                                    <div class="modal-info-value"><?php echo e(optional($selectedReport->approvedBy)->name ?? 'Pending approval'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-info-item" style="background: #ffffff;">
                                            ...
                                            <div class="modal-info-value"><?php echo e($selectedReport->approval_remarks ?? 'No remarks'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-xl-5">
                                    <div class="modal-sidebar-card mb-3">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <div class="small text-muted"><?php echo e(count((array) (($selectedReport->approval_status ?? 'pending') === 'pending' ? ($selectedReport->site_images ?? []) : ($selectedReport->admin_site_images ?? [])))); ?> uploaded</div>
                                        </div>
                                        <?php
                                        ...
                                        ?>
                                        <?php if($fullImageUrls->isNotEmpty()): ?>
                                            <div class="modal-image-grid mb-3" data-gallery='<?php echo e($fullImageUrls->toJson()); ?>' data-gallery-offset="0">
                                                <?php $__currentLoopData = $fullImageUrls->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <button type="button" class="modal-image-thumb lightbox-trigger" data-full-image="<?php echo e($imageUrl); ?>" aria-label="Preview site image">
                                                        <img src="<?php echo e($imageUrl); ?>" alt="Site image">
                                                    </button>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($fullImageUrls->count() > 8): ?>
                                        ...
                                        <div class="modal-timeline">
                                            ...
                                            <div class="modal-timeline-step <?php echo e($reportStatus !== 'pending' ? 'active' : 'current'); ?>">
                                                <div class="modal-timeline-icon"><i class="bi bi-clock"></i></div>
                                                <div class="modal-timeline-label">Under Review</div>
                                            </div>
                                            <div class="modal-timeline-step <?php echo e($reportStatus === 'approved' ? 'active' : ''); ?>">
                                    ...
                                    <?php if($selectedReport->status === 'pending'): ?>
                                        <div class="modal-action-row">
                                            <button type="button" class="btn-modal btn-modal-reject js-reject-report" data-report-id="<?php echo e($selectedReport->report_id); ?>">
                                                <i class="bi bi-x-lg"></i> Reject
                                            </button>
                                            <button type="button" class="btn-modal btn-modal-approve js-approve-report" data-report-id="<?php echo e($selectedReport->report_id); ?>">
                                    ...
                                    <?php else: ?>
                                        <div class="modal-status-note">
                                            ...
                                            This report has already been <?php echo e($selectedReport->status === 'approved' ? 'approved' : 'rejected'); ?>.
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const reportsDataUrl = '<?php echo e(route('admin.reports.data')); ?>';
            const reportsBaseUrl = '<?php echo e(url('/admin/reports')); ?>';
            const detailsBaseUrl = reportsBaseUrl;
            const downloadBaseUrl = reportsBaseUrl;
            const storageBaseUrl = '<?php echo e(rtrim(asset('storage'), '/')); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\admin\reports.blade.php ENDPATH**/ ?>