...
<head>
    ...
    <title>Project Report Images - <?php echo e($project->project_name); ?></title>
    <style>
...
<body>
    <div>
        ...
        <table class="meta-grid">
            <tr class="meta-row">
                <td class="meta-cell">
                    <span class="label">Project Name</span><span class="value"><?php echo e($project->project_name); ?></span>
                </td>
                <td class="meta-cell">
                    <span class="label">Client</span><span class="value"><?php echo e(optional($project->client)->name ?? optional($project->client)->company_name ?? 'N/A'); ?></span>
                </td>
            </tr>
            <tr class="meta-row">
                <td class="meta-cell">
                    <span class="label">Location</span><span class="value"><?php echo e($project->project_location ?? $project->location ?? 'N/A'); ?></span>
                </td>
                <td class="meta-cell">
                    <span class="label">Total Reports</span><span class="value"><?php echo e(count($reports)); ?></span>
                </td>
            </tr>
        </table>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="report-section">
                <div class="report-section-header">Report <?php echo e(str_pad($loop->iteration, 2, '0', STR_PAD_LEFT)); ?> / Accomplishment</div>
                <div class="report-section-body">
                    <div class="report-meta-row">
                        <div class="report-meta-item">
                            <span>Date: </span><strong><?php echo e($report->report_date?->format('M d, Y') ?? $report->created_at->format('M d, Y')); ?></strong>
                        </div>
                        <div class="report-meta-item">
                            <span>Phase: </span><strong><?php echo e(optional($report->phase)->phase_name ?? 'N/A'); ?></strong>
                        </div>
                        <div class="report-meta-item">
                            <span>Status: </span><strong><?php echo e(ucfirst($report->approval_status)); ?></strong>
                        </div>
                    </div>
                    <?php if($report->report_text): ?>
                        <div class="report-description"><span class="label">Accomplishments</span><?php echo e($report->report_text); ?></div>
                    <?php endif; ?>
                    <?php if($report->admin_report_text): ?>
                        <div class="report-description"><span class="label">Admin Notes</span><?php echo e($report->admin_report_text); ?></div>
                    <?php endif; ?>
                    ...
                    <?php if($pdfImages->isNotEmpty()): ?>
                        <table class="images-grid">
                            <?php $__currentLoopData = $pdfImages->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <?php $__currentLoopData = $imageRow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="image-item"><img src="<?php echo e($image); ?>" alt="Report Image"></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php for($empty = $imageRow->count(); $empty < 3; $empty++): ?><td class="image-item"></td><?php endfor; ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </table>
                    <?php else: ?>
        ...
        <div class="footer">
            D&amp;G Construction Management System &middot; Exported <?php echo e(now()->format('M d, Y H:i:s')); ?>

        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\admin\reports\images-pdf.blade.php ENDPATH**/ ?>