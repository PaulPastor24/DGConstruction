                                                ...
                                                <div class="report-detail-card p-4">
                                                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-3 mb-4 p-3 rounded-3" style="background: #fff;">
                                                        <div>
                                                            ...
                                                            <div class="fw-bold text-dark" style="font-size: 1.1rem;">RPT-2026-<?php echo e(str_pad($report->report_id, 4, '0', STR_PAD_LEFT)); ?></div>
                                                        </div>
                                                    ...
                                                    <div class="row g-3 mb-4 small">
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            ...
                                                            <div class="text-dark js-detail-project"><?php echo e(optional($report->project)->project_name ?? 'N/A'); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            <div class="fw-semibold text-muted mb-1">Construction Phase</div>
                                                            <div class="text-dark js-detail-phase"><?php echo e(optional($report->phase)->phase_name ?? 'N/A'); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            <div class="fw-semibold text-muted mb-1">Report Date</div>
                                                            <div class="text-dark js-detail-date"><?php echo e(optional($report->report_date)->format('M d, Y h:i A') ?? 'N/A'); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            <div class="fw-semibold text-muted mb-1">Submitted By</div>
                                                            <div class="text-dark"><?php echo e(optional($report->submittedBy)->name ?? 'Supervisor'); ?></div>
                                                        </div>
                                                    </div>
...
<div class="modal fade cms-modal" id="createReportModal" tabindex="-1" aria-labelledby="createReportModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form id="createReportForm" action="<?php echo e(route('supervisor.reports.submit')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
