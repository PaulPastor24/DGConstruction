<?php $__env->startSection('title', 'My Projects - Client Portal'); ?>
<?php $__env->startSection('mobileTitle', 'My Projects'); ?>
...
<div class="container-fluid p-0">
    ...
    <div class="row g-3 mb-4 align-items-center">
        ...
        <div class="col-6 col-xl-3">
            <div class="project-summary-box">
                ...
                <div>
                    ...
                    <h3><?php echo e($activeTrackCount); ?></h3>
        ...
        <div class="col-12 col-md-6 col-xl-6 ms-auto">
            <div class="project-filter-toolbar">
                <form id="projectFilterForm" class="project-filter-form" action="<?php echo e(route('client.myprojects')); ?>" method="GET">
                    <div class="position-relative project-search-field">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control filter-search-input" placeholder="Search projects..." id="projectSearchInput">
                    </div>
                    ...
                    <div class="project-select-fields-wrapper-group">
                        ...
                        <select name="phase" class="form-select project-filter-select" data-filter-trigger>
                            ...
                            <?php $__currentLoopData = $availablePhases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($phase); ?>" <?php echo e(request('phase') === $phase ? 'selected' : ''); ?>><?php echo e($phase); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <select name="completion" class="form-select project-filter-select" data-filter-trigger>
                            <option value="">All Completion</option>
                            <option value="completed" <?php echo e(request('completion') === 'completed' ? 'selected' : ''); ?>>Completed</option>
                            <option value="in_progress" <?php echo e(request('completion') === 'in_progress' ? 'selected' : ''); ?>>In Progress</option>
                            <option value="at_risk" <?php echo e(request('completion') === 'at_risk' ? 'selected' : ''); ?>>At Risk</option>
                        </select>
                    </div>
                </form>
            </div>
    ...
    <div id="projectsGallery" class="project-feed-dynamic-3card-layout-matrix">
        <?php echo $__env->make('client.partials.project-gallery', ['projects' => $projects], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <div class="d-flex justify-content-between align-items-center mt-5 flex-wrap gap-2 result-reporting-footer-bar">
        <span class="text-muted text-sm" id="resultsSummary" style="font-size: 0.88rem; font-weight: 500;">Showing <?php echo e($projects->firstItem() ?? 0); ?> to <?php echo e($projects->lastItem() ?? 0); ?> of <?php echo e($projects->total()); ?> active records</span>
    </div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\client\myprojects.blade.php ENDPATH**/ ?>