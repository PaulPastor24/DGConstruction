<?php $__env->startSection('title', 'Project Timeline - Supervisor View'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid p-0">
    <?php if(isset($projectsWithStats) && count($projectsWithStats) > 0): ?>
        <div class="d-flex flex-column gap-4">
            <?php $__currentLoopData = $projectsWithStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="project-timeline-wrapper" id="project-panel-<?php echo e($projectId); ?>" style="<?php echo e($selectedProjectId == $projectId ? '' : 'display: none;'); ?>">
                    
                    <div class="dashboard-panel mb-2">
                        <div class="row align-items-center mb-3">
                            <div class="col">
                                <span class="panel-eyebrow">Current Active Phase</span>
                                <h1 class="panel-main-title mt-1"><?php echo e($currentPhaseName); ?> <span class="text-muted font-weight-normal">(Current)</span></h1>
                                <div class="panel-subtext"><?php echo e($projectSupervisors); ?> • <?php echo e($projectLocation); ?></div>
                            </div>
                            <div class="col-auto d-flex gap-3 align-items-center flex-wrap">
                                ...
                                <div class="project-selector-dropdown-wrapper">
                                    ...
                                    <select class="form-select project-theme-select" onchange="window.location.href='<?php echo e(route('supervisor.timeline')); ?>?project_id=' + this.value">
                                        <?php $__currentLoopData = $projectsWithStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dropdownProject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e(data_get($dropdownProject, 'id')); ?>" <?php echo e(data_get($dropdownProject, 'id') == $selectedProjectId ? 'selected' : ''); ?>>
                                                <?php echo e(data_get($dropdownProject, 'name', 'Project')); ?>
                                ...
                                <span class="badge-status-pill completed-count">
                                    ...
                                    <?php echo e(collect($phases)->where('status', 'completed')->count()); ?>/<?php echo e(count($phases)); ?> Completed
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                ...
                                <span class="progress-value-text"><?php echo e(number_format($currentPhaseProgress, 0)); ?>%</span>
                            </div>
                            <div class="progress custom-progress-track">
                                <div class="progress-bar custom-progress-fill" role="progressbar" style="width: <?php echo e($currentPhaseProgress); ?>%;" aria-valuenow="<?php echo e($currentPhaseProgress); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4 timeline-meta-row">
                            <div class="col-6 col-md-3">
                                <div class="meta-metric-card">
                                    ...
                                    <div class="meta-card-value"><?php echo e($currentPhaseStart ? \Carbon\Carbon::parse($currentPhaseStart)->format('M d, Y') : 'Pending'); ?></div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                                <div class="meta-metric-card">
                                    <div class="meta-card-label"><i class="bi bi-calendar-minus me-1"></i> Planned End</div>
                                    <div class="meta-card-value"><?php echo e($currentPhaseEnd ? \Carbon\Carbon::parse($currentPhaseEnd)->format('M d, Y') : 'Pending'); ?></div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                                <div class="meta-metric-card">
                                    <div class="meta-card-label"><i class="bi bi-person-check me-1"></i> Actual Start</div>
                                    <div class="meta-card-value"><?php echo e($currentPhaseActualStart ? \Carbon\Carbon::parse($currentPhaseActualStart)->format('M d, Y') : 'Pending'); ?></div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                                <div class="meta-metric-card">
                                    <div class="meta-card-label"><i class="bi bi-hourglass-split me-1"></i> Estimated Remaining</div>
                                    <div class="meta-card-value"><?php echo e($estimatedRemaining !== null ? $estimatedRemaining . ' days' : 'TBD'); ?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-7">
                                <div class="schedule-insight-box">
                                    <div class="d-flex align-items-start gap-3">
                                        <div class="insight-icon-shell <?php echo e($insightClass); ?>"><i class="bi <?php echo e($insightClass === 'on-track-bg' ? 'bi-check-circle-fill' : 'bi-exclamation-triangle-fill'); ?>"></i></div>
                                        <div>
                                            <div class="insight-title">Schedule Insight: <span class="<?php echo e($insightClass === 'on-track-bg' ? 'text-success' : 'text-amber-deep'); ?> fw-bold"><?php echo e($insightTitle); ?></span></div>
                                            <div class="insight-desc"><?php echo e($insightDescription); ?></div>
                                        </div>
                                        <span class="badge-alert-pill <?php echo e($insightClass); ?> ms-auto"><?php echo e($insightBadge); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-5 d-flex gap-2 justify-content-md-end">
                                <a href="<?php echo e(route('supervisor.phases')); ?>" class="btn btn-timeline-primary"><i class="bi bi-kanban me-2"></i> View Phase Timeline</a>
                                <a href="<?php echo e(route('supervisor.reports')); ?>" class="btn btn-timeline-outline"><i class="bi bi-file-earmark-text me-2"></i> Submit Daily Report</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4 kpi-summary-row">
                        <div class="col-6 col-md-4 custom-col-five kpi-overall-card">
                            <div class="kpi-panel-card">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-2">
                                    <h3 class="kpi-value mb-0"><?php echo e(number_format($projectProgress, 1)); ?>%</h3>
                                    <div class="radial-progress-dummy" style="--value: <?php echo e($projectProgress); ?>"></div>
                                </div>
                        ...
                        <div class="col-6 col-md-4 custom-col-five kpi-secondary-card">
                            <div class="kpi-panel-card">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    ...
                                    <h3 class="kpi-value mb-0"><?php echo e(collect($phases)->where('status', 'completed')->count()); ?></h3>
                                </div>
                        ...
                        <div class="col-6 col-md-4 custom-col-five kpi-secondary-card">
                            <div class="kpi-panel-card">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    ...
                                    <h3 class="kpi-value mb-0"><?php echo e(collect($phases)->whereIn('status', ['upcoming', 'planned', 'not_started', 'delayed'])->count()); ?></h3>
                                </div>
                        ...
                        <div class="col-6 col-md-6 col-xl-2.4 custom-col-five kpi-secondary-card">
                            <div class="kpi-panel-card">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    ...
                                    <h3 class="kpi-value mb-0"><?php echo e($activeMilestoneCount); ?></h3>
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-2.4 custom-col-five kpi-secondary-card">
                            <div class="kpi-panel-card">
                                ...
                                <div class="mt-2">
                                    <h3 class="kpi-value <?php echo e($scheduleHealthClass); ?> mb-0"><?php echo e($scheduleHealthLabel); ?></h3>
                                </div>
                    ...
                    <div class="row g-4 align-items-start timeline-content-row">
                        <div class="col-12 col-lg-6">
                            <div class="dashboard-panel w-100 construction-progress-panel">
                                <div class="construction-progress-header mb-3">
                                    ...
                                    <span class="construction-progress-count"><?php echo e(count($phases)); ?> phases</span>
                                </div>
                                ...
                                <div class="d-flex flex-column py-2 dynamic-timeline-stepper">
                                    <?php $__currentLoopData = $phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="timeline-phase-card-item <?php echo e($borderClass); ?>">
                                            <div class="w-100">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    <div>
                                                        <h4 class="stepper-phase-name mb-1"><?php echo e(data_get($phase, 'name')); ?></h4>
                                                        <div class="stepper-phase-dates">
                                                            <i class="bi bi-calendar3 me-1"></i>
                                                            <?php echo e(data_get($phase, 'start') ? \Carbon\Carbon::parse(data_get($phase, 'start'))->format('M d, Y') : 'TBD'); ?> - 
                                                            <?php echo e(data_get($phase, 'end') ? \Carbon\Carbon::parse(data_get($phase, 'end'))->format('M d, Y') : 'TBD'); ?>

                                                        </div>
                                                    </div>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <span class="stepper-percentage fw-bold text-dark"><?php echo e(number_format($pProgress, 0)); ?>%</span>
                                                        <?php echo $statusLabel; ?>

                                                    </div>
                                                </div>
                                                <div class="timeline-progress-shell">
                                                    <?php if($phaseMilestones->isNotEmpty()): ?>
                                                        <div class="milestone-track">
                                                            <?php $__currentLoopData = $phaseMilestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                                ...
                                                                ?>
                                                                <div class="milestone-marker-wrapper" style="left: <?php echo e($markerPercent); ?>%;">
                                                                    <button type="button" class="<?php echo e($milestoneFlagClass); ?>" aria-label="Milestone: <?php echo e($milestoneName); ?>">
                                                                        <i class="bi bi-flag-fill"></i>
                                                                    </button>
                                                                    <div class="milestone-info-card" role="tooltip">
                                                                        <div class="milestone-info-title"><?php echo e($milestoneName); ?></div>
                                                                        <div class="milestone-info-row">
                                                                            <span>Start</span>
                                                                            <strong><?php echo e($milestoneLabel); ?></strong>
                                                                        </div>
                                                                        <div class="milestone-info-row">
                                                                            <span>End</span>
                                                                            <strong><?php echo e($milestoneActualLabel ?? 'TBD'); ?></strong>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="progress" style="height: 6px; background-color: #f1f5f9; border-radius: 999px;">
                                                        <div class="progress-bar" role="progressbar" style="width: <?php echo e($pProgress); ?>%; background: linear-gradient(90deg, #4DA078, #82DB72);" aria-valuenow="<?php echo e($pProgress); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-12 col-lg-6 timeline-supporting-column">
                            ...
                            ?>
                            <div class="row g-3">
                                <?php if($activeMilestones->isEmpty()): ?>
                                    <div class="col-12">
                                ...
                                <?php else: ?>
                                    <?php $__currentLoopData = $activeMilestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                        <div class="col-12 col-sm-6">
                                            <div class="milestone-sub-card <?php echo e($statusClass); ?>">
                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                    <i class="bi bi-flag-fill text-success"></i>
                                                    <div class="milestone-card-title"><?php echo e(data_get($milestone, 'name')); ?></div>
                                                </div>
                                                <div class="milestone-target-text mb-3"><?php echo e(data_get($milestone, 'phase_name')); ?> • <?php echo e($plannedDate ? \Carbon\Carbon::parse($plannedDate)->format('M d, Y') : 'TBD'); ?></div>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <span class="text-muted small">Days Remaining</span>
                                                    <span class="fw-bold text-dark small"><?php echo e(is_int($daysRemaining) ? $daysRemaining . ' days' : $daysRemaining); ?></span>
                                                </div>
                                                <div class="progress mt-1" style="height: 5px; background-color: #f1f5f9; border-radius: 999px;">
                                                    <div class="progress-bar bg-success" style="width: <?php echo e($progressValue); ?>%;" aria-valuenow="<?php echo e($progressValue); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <span class="badge-status-pill active-bg d-inline-block mt-3"><?php echo e($statusText); ?></span>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                        ...
                                        <div class="schedule-box-segment mb-3">
                                            ...
                                            <div class="d-flex flex-column gap-2 mt-2">
                                                <div>
                                                    ...
                                                    <span class="date-val fw-bold text-dark ms-1"><?php echo e($currentPhaseStart ? \Carbon\Carbon::parse($currentPhaseStart)->format('M d, Y') : 'Pending'); ?></span>
                                                </div>
                                                <div>
                                                    <span class="dot-indicator green-bg"></span>
                                                    <span class="date-label text-muted">End Date:</span>
                                                    <span class="date-val fw-bold text-dark ms-1"><?php echo e($currentPhaseEnd ? \Carbon\Carbon::parse($currentPhaseEnd)->format('M d, Y') : 'Pending'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="schedule-box-segment">
                                            ...
                                            <div class="d-flex flex-column gap-2 mt-2">
                                                <div>
                                                    ...
                                                    <span class="date-val fw-bold text-dark ms-1"><?php echo e($currentPhaseActualStart ? \Carbon\Carbon::parse($currentPhaseActualStart)->format('M d, Y') : 'Pending'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="dashboard-panel delivery-outlook-panel">
                                        ...
                                        <div class="delivery-outlook-date">
                                            ...
                                            <strong><?php echo e($deliveryTargetDate ? $deliveryTargetDate->format('M d, Y') : 'Pending'); ?></strong>
                                        </div>
                                        <div class="delivery-outlook-grid mt-3">
                                            <div>
                                                <span>Current phase</span>
                                                <strong><?php echo e($currentPhaseName); ?></strong>
                                            </div>
                                            <div>
                                                <span>Phase progress</span>
                                                <strong><?php echo e(number_format($currentPhaseProgress, 0)); ?>%</strong>
                                            </div>
                                            <div>
                                                <span>Time outlook</span>
                                                <strong><?php echo e($deliveryDaysRemaining === null ? 'TBD' : ($deliveryDaysRemaining >= 0 ? $deliveryDaysRemaining . ' days left' : abs($deliveryDaysRemaining) . ' days overdue')); ?></strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\resources\views\supervisor\timeline.blade.php ENDPATH**/ ?>