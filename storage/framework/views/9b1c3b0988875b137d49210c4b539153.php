...
<div class="login-shell">
    ...
    <section class="login-hero">
        <a href="<?php echo e(url('/')); ?>" class="back-link" aria-label="Back to homepage">
        ...
        <div class="hero-content-wrap">
            ...
            <div class="hero-brand-row">
                <img class="hero-logo-left" src="<?php echo e(asset('images/image.png')); ?>" alt="D&G Construction logo">
    ...
    <section class="login-panel">
        <div class="login-card">
            ...
            <a href="<?php echo e(route('auth.google.redirect')); ?>" class="login-btn" style="display:block;text-align:center;text-decoration:none;margin-top:12px;background:#fff;color:#1f2937;border:1px solid #d1d5db;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if(session('error')): ?>
            Swal.fire({
                icon: 'error',
                title: 'Login Failed',
                text: <?php echo e(json_encode(session('error'))); ?>,
...
</html><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\auth\login.blade.php ENDPATH**/ ?>