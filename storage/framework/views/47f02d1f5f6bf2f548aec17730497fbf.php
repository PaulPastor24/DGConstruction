...
#tools-view .mi-metric-grid {
    --tool-card-gap: 0.35rem;
    margin-bottom: 0.9rem !important;
}

#tools-view .mi-metric-grid > [class*="col-"] {
    padding-left: 0.35rem;
    padding-right: 0.35rem;
}

#tools-view .mi-metric-grid > .col-lg-3,
#tools-view .mi-metric-grid > .col-md-6,
#tools-view .mi-metric-grid > .col-6 {
    flex: 0 0 22%;
    max-width: 22%;
}
                    ...
                    <div id="tools-view" class="inventory-view-panel <?php echo e($activeInventoryView !== 'tools' ? 'd-none' : ''); ?>">
                        ...
                        <form method="GET" action="<?php echo e(route('admin.inventory')); ?>" class="row g-2 align-items-center mb-4" id="tools-search-form">
                            ...
                            <div class="col-lg-2 col-md-12 col-12 inventory-action-stack">
                                <button type="button" id="addToolBtn" class="btn btn-outline-success btn-sm px-3 fw-semibold bg-white text-dark" data-bs-toggle="modal" data-bs-target="#addToolModal">
...
<script>
    window.openInventoryModal = function (modalId) {
        ...
        try {
            document.querySelectorAll('.modal').forEach(function (modal) {
                if (modal.parentElement && modal.parentElement.closest('.modal')) {
            ...
            console.warn('Failed to open inventory modal:', error);
        }
    };
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function repairNestedModalHierarchy() {
            document.querySelectorAll('.modal').forEach(function (modal) {
                if (modal.parentElement && modal.parentElement.closest('.modal')) {
                    document.body.appendChild(modal);
                }
        ...
        function bindToolModalHandlers() {
            document.querySelectorAll('.btn-issue-tool').forEach(function (btn) {
                if (btn.dataset.toolHandlerBound === '1') {
                    return;
                }

                btn.onclick = null;
                btn.dataset.toolHandlerBound = '1';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views/admin/inventory.blade.php ENDPATH**/ ?>