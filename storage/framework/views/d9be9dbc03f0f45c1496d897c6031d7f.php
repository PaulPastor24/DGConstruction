<?php $__env->startSection('title', 'Supervisor Notifications'); ?>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="metric-card p-3 d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="mb-0 fw-bold"><?php echo e($totalNotifs); ?></h4>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="metric-card p-3 d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="mb-0 fw-bold"><?php echo e($unreadCount); ?></h4>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="metric-card p-3 d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="mb-0 fw-bold"><?php echo e($readCount); ?></h4>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <div class="metric-card p-3 d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <h4 class="mb-0 fw-bold"><?php echo e($archivedCount); ?></h4>
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-3">
    <div class="filter-scroll-container w-100 style-scrollbar">
        <a href="?type=all" class="btn-filter-chip <?php echo e(request('type', 'all') == 'all' ? 'active' : ''); ?>">All</a>
        <a href="?type=unread" class="btn-filter-chip <?php echo e(request('type') == 'unread' ? 'active' : ''); ?>">
            Unread <span class="badge rounded-pill bg-success"><?php echo e($unreadCount); ?></span>
        </a>
        <a href="?type=read" class="btn-filter-chip <?php echo e(request('type') == 'read' ? 'active' : ''); ?>">Read</a>
        <a href="?type=project" class="btn-filter-chip <?php echo e(request('type') == 'project' ? 'active' : ''); ?>">Project</a>
        <a href="?type=report" class="btn-filter-chip <?php echo e(request('type') == 'report' ? 'active' : ''); ?>">Report</a>
        <a href="?type=phase" class="btn-filter-chip <?php echo e(request('type') == 'phase' ? 'active' : ''); ?>">Phase</a>
        <a href="?type=timeline" class="btn-filter-chip <?php echo e(request('type') == 'timeline' ? 'active' : ''); ?>">Timeline</a>
        <a href="?type=attendance" class="btn-filter-chip <?php echo e(request('type') == 'attendance' ? 'active' : ''); ?>">Attendance</a>
        <a href="?type=announcement" class="btn-filter-chip <?php echo e(request('type') == 'announcement' ? 'active' : ''); ?>">Announcement</a>
        <a href="?type=system" class="btn-filter-chip <?php echo e(request('type') == 'system' ? 'active' : ''); ?>">System</a>
    </div>
...
<section class="main-notif-card overflow-hidden mb-4">
    <div class="d-flex flex-column">
        ...
        <?php else: ?>
            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="notif-list-group-item d-flex align-items-start gap-3 <?php echo e($isUnread ? 'unread-row' : ''); ?>">
                    <div class="pt-2">
                        <span class="unread-dot-indicator"></span>
                    </div>

                    <div class="notif-circle-icon notif-<?php echo e($rawType); ?>">
                        <i class="bi <?php echo e($currentIcon); ?>"></i>
                    </div>

                    <div class="flex-grow-1">
                        <div class="fw-bold text-dark mb-0" style="font-size: 0.95rem;"><?php echo e($notification['title']); ?></div>
                        <div class="text-secondary my-1" style="font-size: 0.88rem; line-height: 1.4;">
                            <?php echo e($notification['message']); ?>

                        </div>
                        <?php if(isset($notification['report_id'])): ?>
                            <div class="text-muted font-monospace mb-1" style="font-size: 0.78rem;">
                                <i class="bi bi-shield-check"></i> Report ID: RPT-2026-<?php echo e(str_pad($notification['report_id'], 4, '0', STR_PAD_LEFT)); ?>
                    ...
                    <div class="d-none d-md-block text-nowrap">
                        <span class="badge-type-pill badge-type-pill px-2 py-1 bg-<?php echo e($rawType); ?>">
                            <?php echo e($notification['type'] ?? 'General'); ?>
                    ...
                    <div class="text-nowrap d-none d-sm-block text-start" style="width: 110px;">
                        <div class="fw-bold text-dark" style="font-size: 0.8rem;">
                            <?php echo e(isset($notification['created_at']) ? $notification['created_at']->format('M d, Y') : 'Jul 03, 2026'); ?>

                        </div>
                        <div class="text-muted" style="font-size: 0.72rem;">
                            <?php echo e(isset($notification['created_at']) ? $notification['created_at']->diffForHumans() : 'Just now'); ?>
                    ...
                    <div class="text-end flex-shrink-0">
                        ...
                        ?>
                        <a href="<?php echo e($href); ?>" class="btn-action-view notif-action-view" data-notif-id="<?php echo e($notification->id ?? $notification['id'] ?? ''); ?>">
    ...
    <div class="p-3 bg-light d-flex justify-content-between align-items-center border-top">
        <div class="small text-muted">
            Showing <?php echo e($notifications->firstItem() ?? 0); ?> to <?php echo e($notifications->lastItem() ?? 0); ?> of <?php echo e($notifications->total() ?? $notifications->count()); ?> notifications
        </div>
        <nav aria-label="Page navigation example">
            <?php echo $notifications->links('pagination::bootstrap-5'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const csrf = document.querySelector('meta[name="csrf-token"]') ? document.querySelector('meta[name="csrf-token"]').getAttribute('content') : '<?php echo e(csrf_token()); ?>';
                ...
                if (btn.textContent.includes('Mark all as read')) {
                    btn.addEventListener('click', function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (res.isConfirmed) {
                                fetch('<?php echo e(route('supervisor.notifications.markAllRead')); ?>', {
                                    method: 'POST',
                                    headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\supervisor\notifications.blade.php ENDPATH**/ ?>