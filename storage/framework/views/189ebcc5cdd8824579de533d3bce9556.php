<?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $summary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <?php
    ...
    <article class="project-dashboard-tile" data-project-card data-bs-toggle="modal" data-bs-target="#projectDetailModal-<?php echo e($projectItem->project_id); ?>" tabindex="0" role="button" aria-label="Open details for <?php echo e($projectItem->project_name); ?>">
        <div class="project-dashboard-cover">
            <img src="<?php echo e($projectImage); ?>" alt="<?php echo e($projectItem->project_name); ?> thumbnail" class="project-dashboard-image">
            <div class="project-dashboard-cover-overlay"></div>
            <span class="project-dashboard-status <?php echo e($statusClass); ?>">
                <span class="status-indicator-dot"></span><?php echo e($statusLabel); ?>
        ...
        <div class="project-dashboard-content">
            <div class="project-dashboard-header-row">
                <h3 class="project-dashboard-title brand-dark-green-header"><?php echo e($projectItem->project_name); ?></h3>
                <div class="project-dashboard-progress-percentage-group">
                    <span class="progress-context-lbl">Overall Progress</span>
                    <strong class="project-dashboard-progress-percentage"><?php echo e(round($percent)); ?>%</strong>
                </div>
            </div>

            <div class="project-dashboard-progress-container">
                <div class="project-dashboard-progress-track">
                    <span class="project-dashboard-progress-bar-fill" style="width: <?php echo e(round($percent)); ?>%;"></span>
                </div>
            </div>
            ...
            <div class="project-dashboard-meta-row">
                <div class="project-dashboard-meta-item">
                    ...
                    <div class="project-dashboard-meta-value-wrapper">
                        ...
                        <span class="project-dashboard-meta-value font-weight-bold-css brand-dark-green-header"><?php echo e($phaseName); ?></span>
                    </div>
                </div>
                ...
                <div class="project-dashboard-meta-item">
                    ...
                    <div class="project-dashboard-meta-value-wrapper">
                        ...
                        <span class="project-dashboard-meta-value"><?php echo e($targetEndDate); ?></span>
                    </div>
                </div>
                ...
                <div class="project-dashboard-action-wrapper">
                    <button type="button" class="project-dashboard-button-link" data-bs-toggle="modal" data-bs-target="#projectDetailModal-<?php echo e($projectItem->project_id); ?>">
    ...
    <div class="modal fade project-command-modal" id="projectDetailModal-<?php echo e($projectItem->project_id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content project-command-shell">
                ...
                <div class="project-command-body">
                    ...
                    <header class="project-command-header">
                        <div class="project-command-header-badge-row">
                            <span class="project-command-status-badge <?php echo e($statusClass); ?>">
                                <span class="status-indicator-dot"></span><?php echo e($statusLabel); ?>

                            </span>
                            <span class="project-command-phase-text-badge">
                                <i class="bi bi-layers me-1 text-success-dg"></i><?php echo e($phaseName); ?>

                            </span>
                        </div>
                        <h2 class="project-command-modal-title brand-dark-green-header"><?php echo e($projectItem->project_name); ?></h2>
                    </header>
                    ...
                    <section class="project-command-summary-panel-matrix">
                        ...
                        <div class="command-panel-card card-highlight-border summary-overall">
                            ...
                            <div class="command-panel-main-val-group">
                                <strong class="command-panel-large-display-val text-success-dg"><?php echo e(round($percent)); ?>%</strong>
                            </div>
                            <div class="command-panel-bar-track">
                                <span class="command-panel-bar-fill-css" style="width: <?php echo e(round($percent)); ?>%;"></span>
                            </div>
                        </div>
                        ...
                        <div class="command-panel-card summary-phase">
                            ...
                            <div class="command-panel-horizontal-split">
                                ...
                                <div class="command-panel-split-copy">
                                    <strong class="command-panel-medium-display-val brand-dark-green-header"><?php echo e($phaseName); ?></strong>
                        ...
                        <div class="command-panel-card card-highlight-border">
                            ...
                            <div class="command-panel-main-val-group">
                                <span class="project-command-status-badge <?php echo e($scheduleHealthClass); ?> project-command-schedule-badge"><?php echo e($scheduleHealth); ?></span>
                            </div>
                        ...
                        <div class="command-panel-card">
                            ...
                            <div class="command-panel-horizontal-split">
                                ...
                                <div class="command-panel-split-copy">
                                    <strong class="command-panel-medium-display-val brand-dark-green-header"><?php echo e($targetEndDate); ?></strong>
                                    <span class="command-panel-subtext-lbl"><?php echo e($daysRemaining); ?> Days Remaining</span>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="project-command-dual-grid-split">
                        ...
                        <section class="project-command-column-section">
                            ...
                            <div class="project-command-media-card">
                                <img src="<?php echo e($projectImage); ?>" alt="<?php echo e($projectItem->project_name); ?> construction operational snapshot">
                            </div>
                        </section>
                        ...
                        <section class="project-command-column-section">
                            ...
                            <div class="project-info-untruncated-list">
                                ...
                                <div class="info-list-row-item">
                                    ...
                                    <div class="info-row-value-block font-semibold brand-dark-green-header"><?php echo e($phaseName); ?></div>
                                </div>
                                ...
                                <div class="info-list-row-item">
                                    ...
                                    <div class="info-row-value-block"><?php echo e($projectManager); ?></div>
                                </div>
                                ...
                                <div class="info-list-row-item">
                                    ...
                                    <div class="info-row-value-block"><?php echo e($siteSupervisor); ?></div>
                                </div>
                                ...
                                <div class="info-list-row-item">
                                    ...
                                    <div class="info-row-value-block"><?php echo e($projectItem->description ?: 'No description available.'); ?></div>
                                </div>
                    ...
                    <section class="project-command-section project-command-fullwidth-update-wrap">
                        <div class="project-command-update-card dynamic-green-accent-card">
                            ...
                            <div class="project-command-update-copy">
                                ...
                                <p class="project-command-update-text-paragraph"><?php echo e($latestUpdate); ?></p>
                                <span class="project-command-update-meta"><?php echo e($latestUpdateMeta); ?></span>
                            </div>
                        </div>
                    </section>
                ...
                <footer class="project-command-footer">
                    ...
                    <a href="<?php echo e(route('client.timeline', ['project_id' => $projectItem->project_id])); ?>" class="project-command-button-primary">
                        View Timeline
                    </a>
                </footer>
...
</style><?php /**PATH C:\xampp\htdocs\dashboard\resources\views\client\partials\project-gallery.blade.php ENDPATH**/ ?>