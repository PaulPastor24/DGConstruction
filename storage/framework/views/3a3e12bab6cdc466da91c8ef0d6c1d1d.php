    ...
    <div class="metrics-row">
        <div class="metric-card project-selector-card">
            ...
            <div class="project-dropdown-trigger">
                <span class="project-name"><?php echo e($primaryProject?->project_name ?? 'Select Project'); ?></span>
        ...
        <div class="metric-card progress-metric-card">
            ...
            <div class="metric-value-large"><?php echo e($overallProgress); ?>%</div>
            <div class="progress-bar-container">
                <div class="progress-bar-fill" style="width: <?php echo e($overallProgress); ?>%"></div>
            </div>
        </div>
        ...
        <div class="metric-card phase-metric-card">
            ...
            <div class="current-phase-highlight">
                ...
                <div class="phase-text-group">
                    <span class="phase-title-text"><?php echo e($activePhase?->phase_name ?? 'None'); ?> (Current)</span>
        ...
        <div class="metric-card health-metric-card">
            ...
            <div class="health-status-wrapper <?php echo e($scheduleHealthClass); ?>">
                ...
                <span class="health-text"><i class="bi bi-plus"></i> <?php echo e($scheduleHealth); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="table-section-container">
        <div class="table-section-header">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('supervisor.timeline')); ?>" class="btn-action-outline"><i class="bi bi-calendar3"></i> View Timeline</a>
            ...
            <table class="phases-data-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $projectPhases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr class="<?php echo e($isPhaseActive ? 'row-active-highlight' : ''); ?>">
                            <td>
                            ...
                            <td>
                                <div class="progress-cell-wrapper">
                                    <span class="progress-percent-value"><?php echo e((float) ($phase->completion_percentage ?? 0)); ?>%</span>
                                    <div class="table-progress-track">
                                        <div class="table-progress-fill" style="width: <?php echo e((float) ($phase->completion_percentage ?? 0)); ?>%"></div>
                                    </div>
                                </div>
                            </td>
                            <td>
        ...
        <div class="table-footer-pagination">
            <span class="pagination-summary-text">Showing 1 to <?php echo e($projectPhases->count()); ?> of <?php echo e($projectPhases->count()); ?> phases</span>
...
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\supervisor\phases-old.blade.php ENDPATH**/ ?>