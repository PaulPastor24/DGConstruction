                                        ...
                                        <div>
                                            ...
                                            <?php if($nextUpcoming): ?>
                                                <div class="upcoming-milestone-panel-strip p-3 border rounded-3 mb-3 d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <h4 class="fw-bold text-dark small mb-1"><?php echo e(data_get($nextUpcoming, 'name')); ?></h4>
                                                        <span class="text-muted small">
                                                            <?php echo e(data_get($nextUpcoming, 'is_completed') ? 'Completed' : (data_get($nextUpcoming, 'is_delayed') ? 'Delayed' : 'Upcoming')); ?>

                                                            • <?php echo e(data_get($nextUpcoming, 'start_date') ? \Carbon\Carbon::parse(data_get($nextUpcoming, 'start_date'))->format('M d, Y') : 'TBD'); ?>
                                        ...
                                        <?php if($nextMilestoneDays !== null): ?>
                                            <div class="alert-countdown-banner p-3 rounded-3 mt-auto">
                                                <div class="d-flex align-items-center gap-2 text-amber-deep fw-bold">
                                                    ...
                                                    <span><?php echo e($nextMilestoneDays); ?> days left</span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\supervisor\timeline.blade.php ENDPATH**/ ?>