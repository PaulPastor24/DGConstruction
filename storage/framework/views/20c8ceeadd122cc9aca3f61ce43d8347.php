...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Client Portal D&G Construction Monitor'); ?></title>
...
<div class="app">
        ...
        <div>
            <div class="sidebar-brand">
                <div class="sidebar-logo-img">
                    <img src="<?php echo e(asset('images/D&G.png')); ?>" alt="D&G Construction logo" style="width: 100%; height: 100%; object-fit: contain;">
                </div>
            ...
            <nav class="sidebar-nav">
                <a href="<?php echo e(route('client.dashboard')); ?>" class="nav-item <?php echo e(Request::routeIs('client.dashboard') ? 'active' : ''); ?>">
                    <i class="bi bi-grid-1x2-fill"></i> Dashboard
                </a>
                <a href="<?php echo e(route('client.myprojects')); ?>" class="nav-item <?php echo e(Request::routeIs('client.myprojects') ? 'active' : ''); ?>">
                    <i class="bi bi-folder-fill"></i> My Projects
                </a>
                <a href="<?php echo e(route('client.timeline')); ?>" class="nav-item <?php echo e(Request::routeIs('client.timeline') ? 'active' : ''); ?>">
                    <i class="bi bi-calendar3-event-fill"></i> Timeline
                </a>
                <a href="<?php echo e(route('client.reports')); ?>" class="nav-item <?php echo e(Request::routeIs('client.reports') || Request::routeIs('client.updates') ? 'active' : ''); ?>">
            ...
            <div class="user-pill">
                <div class="user-info">
                    <div class="avatar-circle">
                        <?php echo e(strtoupper(substr(Auth::user()->name ?? 'C', 0, 1))); ?>

                    </div>
                    <div>
                        <div style="font-size: 0.82rem; font-weight:700; line-height: 1.2;"><?php echo e(Auth::user()->name ?? 'Client Account'); ?></div>
    ...
    <div class="main">
        <div class="global-mobile-nav" aria-label="Global mobile navigation">
            ...
            <div class="mobile-nav-title"><?php echo $__env->yieldContent('mobileTitle', 'D&amp;G Construction'); ?></div>
            <button id="mobileNotificationBell" type="button" class="dashboard-notification-button notification-toggle-btn <?php echo e(($clientUnreadCount ?? 0) > 0 ? 'notification-bell-animate' : ''); ?>" style="position: relative;" aria-label="Notifications">
...
<nav class="client-mobile-tabbar" aria-label="Primary">
    <a href="<?php echo e(route('client.dashboard')); ?>" class="tabbar-item <?php echo e(Request::routeIs('client.dashboard') ? 'active' : ''); ?>">
        <i class="bi bi-grid-1x2-fill"></i>
        <span>Home</span>
    </a>
    <a href="<?php echo e(route('client.myprojects')); ?>" class="tabbar-item <?php echo e(Request::routeIs('client.myprojects') ? 'active' : ''); ?>">
        <i class="bi bi-folder-fill"></i>
        <span>Projects</span>
    </a>
    <a href="<?php echo e(route('client.timeline')); ?>" class="tabbar-item <?php echo e(Request::routeIs('client.timeline') ? 'active' : ''); ?>">
        <i class="bi bi-calendar3-event-fill"></i>
        <span>Timeline</span>
    </a>
    <a href="<?php echo e(route('client.reports')); ?>" class="tabbar-item <?php echo e(Request::routeIs('client.reports') || Request::routeIs('client.updates') ? 'active' : ''); ?>">
        <i class="bi bi-file-earmark-bar-graph-fill"></i>
        <span>Reports</span>
    </a>
    <a href="<?php echo e(route('client.notifications')); ?>" class="tabbar-item <?php echo e(Request::routeIs('client.notifications') ? 'active' : ''); ?>">
        <i class="bi bi-bell"></i>
        <span>Alerts</span>
        <?php if(($clientUnreadCount ?? 0) > 0): ?>
            <span class="tabbar-badge" aria-label="<?php echo e($clientUnreadCount ?? 0); ?> unread"><?php echo e($clientUnreadCount ?? 0); ?></span>
        <?php endif; ?>
    </a>
</nav>
...
<div id="notificationPopup" class="notification-popup" role="dialog" aria-label="Client notifications">
    <div class="notification-popup-header">
        <div>
            <h6>Notifications</h6>
            <div class="text-muted" style="font-size: 0.78rem;"><?php echo e($clientUnreadCount ?? 0); ?> unread</div>
        </div>
        <a href="<?php echo e(route('client.notifications')); ?>" class="btn btn-sm btn-outline-secondary" style="font-size: 0.75rem; border-radius: 999px;">View all</a>
    </div>
    <div class="notification-popup-list">
        <?php $__empty_1 = true; $__currentLoopData = $clientNotifications->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            ?>
            <a href="<?php echo e($link); ?>" class="notification-item d-flex align-items-start gap-2 text-decoration-none <?php echo e($isUnread ? 'unread' : ''); ?>" data-notif-id="<?php echo e($notification->id ?? $notification['id'] ?? ''); ?>" style="color: inherit;">
                <span class="notif-dot mt-2"></span>
                <div class="flex-grow-1">
                    <div class="notification-item-title"><?php echo e($notification['title'] ?? ($notification->title ?? 'Notification')); ?></div>
                    <p class="notification-item-text"><?php echo e($notification['message'] ?? ($notification->message ?? 'You have a new update.')); ?></p>
                    <span class="notification-item-time"><?php echo e($notification['time'] ?? ($notification['created_at'] ? $notification['created_at']->diffForHumans() : ($notification->created_at ? $notification->created_at->diffForHumans() : 'Just now'))); ?></span>
                </div>
            </a>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const notificationMarkReadUrlTemplate = "<?php echo e(route('client.notifications.markRead', ['id' => '__ID__'])); ?>";
...
</html><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\layouts\client.blade.php ENDPATH**/ ?>