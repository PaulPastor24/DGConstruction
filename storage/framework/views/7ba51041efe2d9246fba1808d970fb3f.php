<?php $__env->startSection('title', 'Construction Phases - Supervisor View'); ?>
<?php $__env->startSection('page_title', 'Construction Phases'); ?>
    ...
    <div class="metrics-row">
        <div class="metric-card project-selector-card">
            ...
            <div class="project-dropdown-trigger" id="projectDropdownBtn" role="button" tabindex="0" aria-haspopup="listbox" aria-expanded="false">
                ...
                <span class="project-name" id="selectedProjectName"><?php echo e($primaryProject?->project_name ?? 'Select Project'); ?></span>
                <i class="bi bi-chevron-down dropdown-arrow"></i>
            </div>
            
            
            <div class="project-dropdown-menu" id="projectDropdownMenu" style="display: none;">
                <?php $__empty_1 = true; $__currentLoopData = $assignedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="#" class="dropdown-item" data-project-id="<?php echo e($project->project_id); ?>" data-project-name="<?php echo e($project->project_name); ?>">
        ...
        <div class="metric-card progress-metric-card">
            ...
            <div class="metric-value-large" id="overallProgressValue"><?php echo e($overallProgress); ?>%</div>
            <div class="progress-bar-container">
                <div class="progress-bar-fill" id="overallProgressBar" style="width: <?php echo e($overallProgress); ?>%"></div>
            </div>
        </div>
        ...
        <div class="metric-card phase-metric-card">
            ...
            <div class="current-phase-highlight">
                ...
                <div class="phase-text-group">
                    <span class="phase-title-text" id="currentPhaseName"><?php echo e($activePhase?->phase_name ?? 'None'); ?> (Current)</span>
                    <span class="phase-subtext" id="currentPhaseStatus"><?php echo e($activePhase ? ($activePhase->status === 'in_progress' ? 'In Progress' : ucfirst(str_replace('_', ' ', $activePhase->status))) : 'No phase'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="metric-card health-metric-card">
            ...
            <div class="health-status-wrapper <?php echo e($scheduleHealthClass); ?>" id="scheduleHealthWrapper">
                ...
                <span class="health-text" id="scheduleHealthText"><i class="bi bi-plus"></i> <?php echo e($scheduleHealth); ?></span>
            </div>
            <span class="health-detail" id="scheduleHealthReason"><?php echo e($scheduleHealthReason ?? 'No delayed or overdue phases'); ?></span>
        </div>
    </div>
    ...
    <div class="table-section-container">
        <div class="table-section-header">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('supervisor.timeline')); ?>?project_id=<?php echo e($primaryProject?->project_id ?? ''); ?>" class="btn-action-outline"><i class="bi bi-calendar3"></i> View Timeline</a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="phases-data-table">
                ...
                <tbody id="phasesTableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $projectPhases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr class="<?php echo e($isPhaseActive ? 'row-active-highlight' : ''); ?>" data-phase-id="<?php echo e($phase->phase_id); ?>" data-phase-status="<?php echo e($phase->status); ?>" data-phase-name="<?php echo e(strtolower($phase->phase_name)); ?>">
                            <td>
                                <span class="order-badge"><?php echo e($phase->phase_order); ?></span>
                            </td>
                            <td>
                                <div class="phase-name-cell">
                                    ...
                                    <span class="phase-name-string <?php echo e($isPhaseActive ? 'text-active-theme' : ''); ?>">
                                        <?php echo e($phase->phase_name); ?> <?php if($isPhaseActive): ?> <span class="current-inline-tag">(Current)</span> <?php endif; ?>
                                    </span>
                                </div>
                            </td>
                            <td>
                                <span class="description-text-cell">
                                    Monitor delivery progress and milestone readiness for <?php echo e(strtolower($phase->phase_name)); ?>.
                                </span>
                            </td>
                            <td>
                                <div class="progress-cell-wrapper">
                                    <span class="progress-percent-value"><?php echo e(round((float) ($phase->completion_percentage ?? 0), 0)); ?>%</span>
                                    <div class="table-progress-track">
                                        <div class="table-progress-fill" style="width: <?php echo e(round((float) ($phase->completion_percentage ?? 0), 0)); ?>%"></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="<?php echo e($statusClass($phase->status)); ?>"><?php echo e($statusLabel($phase->status)); ?></span>
                            </td>
                            <td class="date-cell-text"><?php echo e($formatDate($phase->planned_start_date)); ?></td>
                            <td class="date-cell-text"><?php echo e($formatDate($phase->planned_end_date)); ?></td>
                            <td style="text-align: center;">
                                <button class="action-view-row-btn view-phase-details" data-phase-id="<?php echo e($phase->phase_id); ?>" title="View phase" aria-label="View phase">
                                    <i class="bi bi-eye"></i>
                                </button>
                            </td>
                        </tr>
        ...
        <div class="table-footer-pagination">
            <span class="pagination-summary-text">
                Showing <?php echo e($projectPhases->firstItem() ?? 1); ?> to <?php echo e($projectPhases->lastItem() ?? $projectPhases->count()); ?> of <?php echo e($projectPhases->total()); ?> phases
            </span>
            <div class="pagination-controls">
                <?php if($projectPhases->onFirstPage()): ?>
                    <button class="pag-btn" disabled><i class="bi bi-chevron-left"></i></button>
                <?php else: ?>
                    <a href="<?php echo e($projectPhases->previousPageUrl()); ?>&project_id=<?php echo e($primaryProject?->project_id); ?>" class="pag-btn"><i class="bi bi-chevron-left"></i></a>
                <?php endif; ?>
                
                <?php for($i = 1; $i <= $projectPhases->lastPage(); $i++): ?>
                    <?php if($i == $projectPhases->currentPage()): ?>
                        <button class="pag-btn pag-btn-active"><?php echo e($i); ?></button>
                    <?php else: ?>
                        <a href="<?php echo e($projectPhases->url($i)); ?>&project_id=<?php echo e($primaryProject?->project_id); ?>" class="pag-btn"><?php echo e($i); ?></a>
                    <?php endif; ?>
                <?php endfor; ?>
                
                <?php if($projectPhases->hasMorePages()): ?>
                    <a href="<?php echo e($projectPhases->nextPageUrl()); ?>&project_id=<?php echo e($primaryProject?->project_id); ?>" class="pag-btn"><i class="bi bi-chevron-right"></i></a>
                <?php else: ?>
...
<?php if(!View::exists('layouts.includes.sweetalert2')): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    projectItems.forEach(item => {
        item.addEventListener('click', (e) => {
            ...
            window.location.href = `<?php echo e(route('supervisor.phases')); ?>?project_id=${projectId}`;
        });
    });
    ...
    viewDetailsButtons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            // Fetch phase details
            fetch(`<?php echo e(route('supervisor.api.phases.details', ':id')); ?>`.replace(':id', phaseId))
                        ...
                        if (canManage) {
                            ...
                            changeStatusBtn.addEventListener('click', function() {
                                ...
                                Swal.fire({
                                    ...
                                    fetch(`<?php echo e(url('/supervisor/api/phases')); ?>/${phase.id}/update-status`, {
                                        method: 'POST',
                                        headers: {
...
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\resources\views\supervisor\phases.blade.php ENDPATH**/ ?>