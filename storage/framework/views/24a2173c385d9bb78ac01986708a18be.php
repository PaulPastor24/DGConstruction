<?php $__env->startSection('title', 'Timeline & Milestones - Client Portal'); ?>

<?php $__env->startSection('content'); ?>
<?php $__env->startSection('pageHeaderLabel', 'PROJECT TRACKING'); ?>
<?php $__env->startSection('pageHeaderTitle', 'Timeline & Milestones'); ?>
<?php $__env->startSection('pageHeaderCopy', 'Real-time progress overview of construction phases and target milestones.'); ?>
    ...
    <div class="card timeline-ui-panel border-0">
        ...
        <div class="card-body px-4 pb-4">
            <div class="d-flex flex-column gap-3 mt-2">
                <?php if(isset($phases) && $phases->count() > 0): ?>
                    <?php $__currentLoopData = $phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="phase-row-item d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="status-indicator-dot-box" style="background-color: <?php echo e($bgColor); ?>; color: <?php echo e($accentColor); ?>;">
                                    <?php if($isCompleted): ?>
                                ...
                                <div>
                                    <h6 class="phase-title-text m-0"><?php echo e($phase->phase_name); ?></h6>
                                    <p class="phase-date-subtext mb-0 mt-1">
                                        <i class="bi bi-calendar3 me-1"></i>
                                        <?php echo e(date('M d', strtotime($phase->start_date))); ?> – <?php echo e(date('M d, Y', strtotime($phase->end_date))); ?> 
                                        
                                        <?php if($phase->status_description): ?>
                                            <span class="status-description-pill ms-2">
                                                <span class="description-dot" style="background-color: <?php echo e($accentColor); ?>;"></span>
                                                <?php echo e($phase->status_description); ?>
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <div class="d-none d-sm-block" style="width: 120px;">
                                    <div class="progress" style="height: 6px; background-color: #e2e8f0; border-radius: 999px;">
                                        <div class="progress-bar" style="width: <?php echo e($phase->progress_percentage); ?>%; background-color: <?php echo e($accentColor); ?>; border-radius: 999px;"></div>
                                    </div>
                                </div>
                                <div class="text-end" style="min-width: 55px;">
                                    <span class="phase-percentage-badge <?php echo e($isCompleted ? 'completed-text' : 'active-text'); ?>">
                                        <?php echo e($isCompleted ? 'Done' : $phase->progress_percentage . '%'); ?>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\client\status.blade.php ENDPATH**/ ?>