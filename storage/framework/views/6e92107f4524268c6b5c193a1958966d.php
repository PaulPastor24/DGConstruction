    ...
    <div class="grid grid-cols-2 gap-1.5 sm:flex sm:flex-wrap sm:items-center sm:justify-end sm:gap-2 sm:ml-auto w-full sm:w-auto mt-1 sm:mt-0">
        <div class="relative col-span-2 sm:col-span-1 sm:min-w-[190px]">
            <select
                ...
                @change="window.location.href = '<?php echo e(route('supervisor.materials')); ?>?project_id=' + $event.target.value + '&tab=' + activeTab"
            ...
            >
                <?php $__currentLoopData = $assignedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($project->project_id); ?>" <?php if(optional($selectedProject)->project_id == $project->project_id): echo 'selected'; endif; ?>><?php echo e($project->project_name); ?></option>
...
<?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\partials\supervisor\material-toggle.blade.php ENDPATH**/ ?>