...
<body class="<?php echo e(request()->is('admin/timeline*') ? 'page-admin-timeline' : ''); ?> <?php echo e(request()->is('admin/users*') ? 'page-admin-users' : ''); ?> <?php echo e(request()->is('admin/inventory*') ? 'page-admin-inventory' : ''); ?> <?php echo e(request()->is('admin/reports*') ? 'page-admin-reports' : ''); ?> <?php echo e(request()->is('admin/phases*') ? 'page-admin-phases' : ''); ?>">
    <div class="app">
...
</html><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\layouts\admin.blade.php ENDPATH**/ ?>