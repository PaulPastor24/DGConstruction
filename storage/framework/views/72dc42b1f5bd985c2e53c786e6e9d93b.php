<?php $__env->startSection('title', 'Admin Profile - Account Settings'); ?>
<?php $__env->startSection('page_title', 'Admin Profile'); ?>
                    ...
                    <div class="ui-avatar-container">
                        <div class="ui-avatar-large d-flex align-items-center justify-content-center text-white overflow-hidden" style="background: linear-gradient(135deg, #2a4028, #4b6b46); font-size: 2.5rem; font-weight: bold;">
                            ...
                            <?php else: ?>
                                ...
                                <span data-profile-initial><?php echo e(strtoupper(substr($user->name ?? 'A', 0, 1))); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="flex-grow-1">
                        <h4 class="fw-bold mb-1"><?php echo e($user->name ?? 'Admin Name'); ?></h4>
                        ...
                        <ul class="summary-list">
                            <li>
                                ...
                                <span class="value"><?php echo e($user->user_id ?? 'N/A'); ?></span>
                            </li>
                            <li>
            ...
            <div class="ui-card d-flex flex-column justify-content-between">
                ...
                <div class="border-top pt-3 mt-2">
                    ...
                    <div class="d-flex align-items-center justify-content-between text-muted small">
                        <div>
                            <span class="fw-semibold text-dark"><?php echo e(optional($user->updated_at)->format('M j, Y') ?? 'Unknown'); ?></span>
                            <span class="mx-2">•</span>
                            <span><?php echo e(optional($user->updated_at)->format('h:i A') ?? '00:00 AM'); ?></span>
                        </div>
                        <div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-xl-4 d-flex flex-column gap-4">
            <div class="ui-card text-center py-4">
                ...
                <div class="px-3">
                    <form id="profilePhotoForm" action="<?php echo e(route('admin.profile.photo')); ?>" method="POST" enctype="multipart/form-data" class="mb-2">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="profileUpdateForm" action="<?php echo e(route('admin.profile.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="passwordModal" tabindex="-1" aria-labelledby="passwordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="passwordUpdateForm" action="<?php echo e(route('admin.profile.password')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <?php if($errors->any()): ?>
            ...
            const hasProfileErrors = <?php echo json_encode($errors->has('first_name') || $errors->has('last_name') || $errors->has('email') || $errors->has('contact_number') || $errors->has('address'), 15, 512) ?>;
            const hasPhotoErrors = <?php echo json_encode($errors->has('profile_photo'), 15, 512) ?>;
            if (passwordModal && hasPasswordErrors) {
                ...
                Swal.fire({
                    ...
                    text: <?php echo json_encode($errors->first('profile_photo'), 15, 512) ?>,
                    confirmButtonColor: '#2a4028'
                });
            }
        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\admin\profile.blade.php ENDPATH**/ ?>