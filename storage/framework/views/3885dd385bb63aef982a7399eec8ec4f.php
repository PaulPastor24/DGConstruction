            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-2 fw-bold text-dark lh-1 my-1"><?php echo e($total_users ?? 0); ?></div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-2 fw-bold text-dark lh-1 my-1"><?php echo e($active_users_count ?? 0); ?></div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-2 fw-bold text-dark lh-1 my-1"><?php echo e($inactive_users_count ?? 0); ?></div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-2 fw-bold text-dark lh-1 my-1"><?php echo e($clients_count ?? 0); ?></div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-2 fw-bold text-dark lh-1 my-1"><?php echo e(($engineers_count ?? 0)); ?></div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-2 fw-bold text-dark lh-1 my-1"><?php echo e($supervisors_count ?? 0); ?></div>
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-md-4 position-relative">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" id="searchInput" class="form-control border-start-0 ps-1" placeholder="Search by name, email, or company name..." value="<?php echo e(request('search')); ?>" autocomplete="off">
                    ...
                    <div class="col-md-2">
                        <select name="role" id="roleFilter" class="form-select text-muted">
                            ...
                            <option value="engineer" <?php echo e(request('role') == 'engineer' ? 'selected' : ''); ?>>Engineer/Administrator</option>
                            <option value="supervisor" <?php echo e(request('role') == 'supervisor' ? 'selected' : ''); ?>>Site Supervisor</option>
                    ...
                    <div class="col-md-2">
                        <select name="per_page" id="perPageFilter" class="form-select text-muted">
                            ...
                            <option value="25" <?php echo e(request('per_page', '25') == '25' ? 'selected' : ''); ?>>25 rows</option>
                        ...
                        <tr>
                            ...
                            <td data-label="User Account">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark lh-base"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></div>
                            ...
                            <td data-label="Contact Number">
                                <?php if($user->contact_number): ?>
                                    <div class="fw-semibold text-secondary small d-flex align-items-center gap-1">
                                        ...
                                        <span><?php echo e($user->contact_number); ?></span>
                                    </div>
                                <?php else: ?>
                            ...
                            <td data-label="Actions" class="text-end pe-4">
                                <div class="d-inline-flex gap-1">
                                    <button type="button"
                                            ...
                                            data-active="<?php echo e($user->is_active ? 1 : 0); ?>"
                                            data-update-url="<?php echo e(route('admin.users.update', $user)); ?>">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon-only border rounded-3 bg-white shadow-sm text-danger" title="Delete User Account" onclick="confirmUserDeletion('<?php echo e($user->user_id); ?>', '<?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>')">
                                        <i class="bi bi-trash3-fill"></i>
                                    </button>
                                    <form id="delete-form-<?php echo e($user->user_id); ?>" action="<?php echo e(route('admin.users.destroy', $user)); ?>" method="POST" style="display: none;">
                                        <?php echo csrf_field(); ?>
                ...
                <article class="ug-user-card">
                    <div class="ug-user-card-head">
                        <div class="avatar-circle-ui ug-user-avatar d-flex align-items-center justify-content-center fw-bold text-white uppercase">
                            <?php echo e($mobileInitials); ?>

                        </div>

                        <div class="ug-user-main">
                            <h3><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h3>
                            <p><i class="bi bi-envelope-open"></i> <?php echo e($user->email); ?></p>
                        </div>
                    ...
                    <div class="ug-user-detail-grid">
                        <div class="ug-user-detail">
                            <span>Role</span>
                            <strong><?php echo e($mobileRoleLabel); ?></strong>
                        </div>

                        <div class="ug-user-detail">
                            <span>Contact</span>
                            <strong><?php echo e($user->contact_number ?: 'Not provided'); ?></strong>
                        </div>

                        <div class="ug-user-detail">
                            <span>Record #</span>
                            <strong><?php echo e(($users->currentPage() - 1) * $users->perPage() + $index + 1); ?></strong>
                        </div>

                        <div class="ug-user-detail">
                            <span>System Access</span>
                            <strong><?php echo e($user->is_active == 1 ? 'Enabled' : 'Disabled'); ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="ug-user-card-actions">
                        ...
                        <button type="button"
                                ...
                                onclick="confirmUserDeletion('<?php echo e($user->user_id); ?>', '<?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>')">
                            <i class="bi bi-trash3-fill"></i>
                            Delete
                        </button>
                    </div>
        ...
        <?php if($users->hasPages() || $users->total() > 0): ?>
            <div class="card-footer bg-white border-top border-light-subtle d-flex flex-wrap align-items-center justify-content-between p-3 gap-2">
                <div class="text-muted small fw-semibold">
                    Showing <span class="text-dark"><?php echo e($users->firstItem() ?? 0); ?></span> to <span class="text-dark"><?php echo e($users->lastItem() ?? 0); ?></span> of <span class="text-dark"><?php echo e($users->total()); ?></span> recorded entries
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const addUserStoreUrl = "<?php echo e(route('admin.users.store')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\admin\users\index.blade.php ENDPATH**/ ?>