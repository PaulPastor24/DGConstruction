<?php $__env->startSection('title', 'Supervisor Dashboard - Field Operations Command'); ?>
<?php $__env->startSection('page_title', 'Supervisor Dashboard'); ?>
    ...
    <section class="page-card">
        <div class="page-hero">
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-start gap-3">
                        <div>
                            <div class="eyebrow">Good Morning, <?php echo e($user->name ?? 'Supervisor'); ?></div>
						...
						<div class="d-flex align-items-center gap-3 flex-wrap">
							<div class="supervisor-project-selector">
								...
								<div class="supervisor-project-selector-field">
									<form id="projectSelectorForm" method="GET" action="<?php echo e(route('supervisor.dashboard')); ?>" class="mb-0 w-100">
										...
										<div class="supervisor-select-wrapper">
											...
											<select id="dashboardProjectId" name="project_id" class="form-select supervisor-project-select" onchange="this.form.submit()" <?php echo e($assignedProjects->isEmpty() ? 'disabled' : ''); ?>>
												...
												<?php else: ?>
													<?php $__currentLoopData = $assignedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($project->project_id); ?>" <?php echo e(optional($primaryProject)->project_id == $project->project_id ? 'selected' : ''); ?>><?php echo e($project->project_name); ?></option>
							...
							<span class="badge rounded-pill badge-soft text-muted fw-semibold">
								<i class="bi bi-calendar3 me-2"></i><?php echo e(now()->format('M d, Y')); ?>
            ...
            <div class="row g-3 mt-1">
                <div class="col-12 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($attendancePresentCount); ?>/<?php echo e($projectWorkersCount); ?></div>
                        <div class="stat-meta">Present workers</div>
                        <div class="d-flex flex-wrap gap-2 mt-2">
                            <span class="badge rounded-pill bg-success-subtle text-success-emphasis">Biometric <?php echo e($attendancePercent); ?>%</span>
                        </div>
                        <div class="small text-muted mt-2"><?php echo e($attendancePresentCount >= $projectWorkersCount ? 'All assigned workers are present.' : ($attendancePresentCount > 0 ? 'Attendance is being tracked today.' : 'Attendance is still pending for today.')); ?></div>
                    </div>
                </div>
                <div class="col-12 col-xl-3">
                    <div class="stat-card">
                        <div class="stat-title">Current Site Phase</div>
                        <div class="stat-value"><?php echo e($primaryPhase->phase_name ?? 'No active phase'); ?></div>
                ...
                <div class="col-12 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($pendingTasksCount); ?></div>
                ...
                <div class="col-12 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value"><?php echo e($upcomingMilestone ? optional($upcomingMilestone->end_date ?? $upcomingMilestone->start_date)->format('M d') : 'No date'); ?></div>
                        <div class="stat-meta"><?php echo e($upcomingMilestone->milestone_name ?? 'No upcoming milestone'); ?></div>
                    </div>
                </div>
            </div>

            <div class="d-flex flex-wrap gap-2 mt-2 align-items-center">
                <a href="<?php echo e(route('supervisor.attendance')); ?>" class="btn btn-primary-soft px-4 py-2">
                    <i class="bi bi-person-check me-2"></i>Record Attendance
                </a>
                <a href="<?php echo e(route('supervisor.reports', ['project_id' => optional($primaryProject)->project_id])); ?>" class="btn btn-outline-soft px-4 py-2">
                    <i class="bi bi-file-earmark-text me-2"></i>Submit Report
                </a>
                <a href="<?php echo e(route('supervisor.timeline', ['project_id' => optional($primaryProject)->project_id])); ?>" class="btn btn-outline-soft px-4 py-2">
            ...
            <section class="section-card">
                <div class="section-card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <span class="badge rounded-pill bg-success-subtle text-success-emphasis"><?php echo e(ucfirst($primaryProject->status ?? 'Active')); ?></span>
                    </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="dashboard-key-value">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold small"><?php echo e($primaryProject->project_name ?? 'No project assigned'); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="dashboard-key-value">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold small"><?php echo e($projectClient); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="dashboard-key-value">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold small"><?php echo e($projectLocation); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="dashboard-key-value">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="fw-semibold small"><?php echo e($projectTargetDate ? $projectTargetDate->format('M d, Y') : 'Pending'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-2">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="fw-semibold text-success"><?php echo e($projectProgress); ?>%</span>
                        </div>
                        <div class="progress-track">
                            <div class="progress-fill" style="width: <?php echo e($projectProgress); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-2">
                        <span class="dashboard-summary-pill">
                            ...
                            <span>Current Phase: <?php echo e($projectPhase); ?></span>
                        </span>
                        <span class="dashboard-summary-pill">
                            <i class="bi bi-hourglass-split"></i>
                            <span><?php echo e($daysRemaining !== null ? $daysRemaining . ' days remaining' : 'Pending'); ?></span>
                        </span>
                    </div>

                    <a href="<?php echo e(route('supervisor.timeline')); ?>" class="btn btn-outline-soft btn-sm mt-2 dashboard-action-btn">View Project Details</a>
                </div>
            </section>
        </div>
                ...
                <div class="section-card-body">
                    ...
                    <div class="dashboard-summary-highlight">
                        <div>
                            ...
                            <div class="dashboard-kpi"><?php echo e(round($phaseProgress, 1)); ?>%</div>
                        </div>
                        <div class="progress-track mt-2">
                            <div class="progress-fill" style="width: <?php echo e(round($phaseProgress, 1)); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-info-stack mt-2">
                        <div class="dashboard-inline-item">
                            ...
                            <span class="fw-semibold small"><?php echo e($primaryPhase?->phase_name ?? 'No active phase'); ?></span>
                        </div>
                        <div class="dashboard-inline-item">
                            <span class="small fw-semibold text-muted text-uppercase">Completed Phases</span>
                            <span class="fw-semibold small"><?php echo e($completedPhaseCount); ?>/<?php echo e($phaseTimeline->count()); ?></span>
                        </div>
                        <div class="dashboard-inline-item">
                            <span class="small fw-semibold text-muted text-uppercase">Next Phase</span>
                            <span class="fw-semibold small"><?php echo e($nextUpcomingPhase); ?></span>
                        </div>
                        <div class="dashboard-inline-item">
                            <span class="small fw-semibold text-muted text-uppercase">Estimated Finish Date</span>
                            <span class="fw-semibold small"><?php echo e($phaseEnd); ?></span>
                        </div>
                    </div>

                    <a href="<?php echo e(route('supervisor.phases')); ?>" class="btn btn-outline-soft btn-sm mt-2 dashboard-action-btn">View Construction Phases</a>
                </div>
            </section>
        </div>
    </div>
            ...
            <section class="section-card">
                <div class="section-card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <span class="badge rounded-pill bg-success-subtle text-success-emphasis"><?php echo e($pendingReports->isNotEmpty() ? 'Pending' : 'Ready'); ?></span>
                    </div>
                    <div class="d-flex flex-column gap-2">
                        <div class="dashboard-inline-item">
                            <span class="small fw-semibold text-muted text-uppercase">Submission Status</span>
                            <span class="fw-semibold small"><?php echo e($pendingReports->isNotEmpty() ? 'Pending' : 'Ready'); ?></span>
                        </div>
                        <div class="dashboard-inline-item">
                        ...
                        <div class="dashboard-inline-item">
                            ...
                            <span class="fw-semibold small"><?php echo e($pendingReports->first()?->created_at?->format('M d') ?? now()->format('M d')); ?></span>
                        </div>
                    </div>
                    <a href="<?php echo e(route('supervisor.reports')); ?>" class="btn btn-primary-soft btn-sm dashboard-action-btn">Submit Report</a>
                </div>
            </section>
        </div>
            ...
            <section class="section-card">
                <div class="section-card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <span class="badge rounded-pill badge-soft"><?php echo e($upcomingMilestone ? 'Watch' : 'Clear'); ?></span>
                    </div>
                    <?php if($upcomingMilestones->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="d-flex flex-column gap-2">
                            <?php $__currentLoopData = $upcomingMilestones->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="dashboard-surface p-3">
                                    <div class="d-flex align-items-start gap-2">
                                        <span class="dashboard-icon"><i class="bi bi-flag-fill"></i></span>
                                        <div>
                                            <div class="fw-semibold small"><?php echo e($milestone->milestone_name); ?></div>
                                            <div class="small text-muted mt-1"><?php echo e(optional($milestone->start_date)->format('M d, Y') ?? 'Pending'); ?></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="section-card-body">
                    ...
                    <?php else: ?>
                        <div class="activity-timeline">
                            <?php $__currentLoopData = $activityItems->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="activity-item">
                                    <div class="activity-icon <?php echo e($activity['iconClass']); ?>">
                                        <i class="bi <?php echo e($activity['icon']); ?>"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between gap-3">
                                            <div class="fw-semibold small"><?php echo e($activity['title']); ?></div>
                                            <span class="small text-muted"><?php echo e($activity['time']); ?></span>
                                        </div>
                                        <div class="small text-muted"><?php echo e($activity['meta']); ?></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\resources\views/supervisor/dashboard.blade.php ENDPATH**/ ?>