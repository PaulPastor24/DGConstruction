<?php $__env->startSection('title', 'Admin Dashboard - D&G Construction Monitor'); ?>
<?php $__env->startSection('page_title', 'Management Dashboard'); ?>
    ...
    <div class="top-row-grid">
        ...
        <div class="hero-banner">
            <div class="hero-content">
                ...
                <a href="<?php echo e(route('admin.projects.index')); ?>" class="hero-btn">
        ...
        <div class="quick-actions-card">
            ...
            <div class="qa-grid">
                <a href="<?php echo e(route('admin.projects.create')); ?>" class="qa-item">
                    <div class="qa-icon"><i class="bi bi-file-earmark-plus"></i></div>
                    New<br>Project
                </a>
                <a href="<?php echo e(route('admin.inventory')); ?>" class="qa-item">
                    <div class="qa-icon"><i class="bi bi-box-seam"></i></div>
                    Add<br>Material
                </a>
                <a href="<?php echo e(route('admin.attendance')); ?>" class="qa-item">
                    <div class="qa-icon"><i class="bi bi-person-plus"></i></div>
                    Add<br>Worker
                </a>
                <a href="<?php echo e(route('admin.reports.index')); ?>" class="qa-item">
    ...
    <div class="stats-grid-4">
        <div class="stat-box">
            ...
            <div class="stat-info">
                ...
                <div class="stat-number"><?php echo e($stats['active_projects'] ?? 0); ?></div>
        ...
        <div class="stat-box">
            ...
            <div class="stat-info">
                ...
                <div class="stat-number"><?php echo e($stats['total_workforce'] ?? 0); ?></div>
        ...
        <div class="stat-box">
            ...
            <div class="stat-info">
                ...
                <div class="stat-number"><?php echo e($stats['inventory_count'] ?? 0); ?></div>
        ...
        <div class="stat-box">
            ...
            <div class="stat-info">
                ...
                <div class="stat-number"><?php echo e($stats['pending_reports'] ?? 0); ?></div>
    ...
    <div class="bottom-row-grid">
        ...
        <div class="dash-card">
            <div class="dash-card-header">
                ...
                <a href="<?php echo e(route('admin.projects.index')); ?>" class="dash-card-link">View all projects &rarr;</a>
            </div>
            ...
            <div class="project-list">
                <?php $__empty_1 = true; $__currentLoopData = $activeProjects ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <div class="project-list-item" data-project-id="<?php echo e($project->id); ?>" data-project-name="<?php echo e($project->name); ?>" data-project-location="<?php echo e($project->location); ?>" data-project-status="<?php echo e($project->status_label); ?>" data-project-phase="<?php echo e($project->current_phase ?? 'N/A'); ?>" data-project-progress="<?php echo e($project->progress_percentage ?? 0); ?>" data-project-image="<?php echo e($project->image ?? ''); ?>" style="cursor: pointer;" onclick="openProjectDetailModal(this)">
                        <img src="<?php echo e($project->image ?? 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=150&q=80'); ?>" alt="Project" class="proj-thumb" onerror="this.onerror=null;this.src='https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=150&q=80';">

                        <div class="proj-details">
                            <div class="proj-title"><?php echo e($project->name); ?></div>
                            <div class="proj-sub"><?php echo e($project->current_phase ?? 'Phase 1 - Construction'); ?></div>
                        </div>

                        <div class="proj-progress-wrapper">
                            <div class="progress-bar-bg">
                                <div class="progress-bar-fill <?php echo e($project->progress_color_class ?? 'blue'); ?>" style="width: <?php echo e($project->progress_percentage); ?>%"></div>
                            </div>
                            <div class="proj-percent"><?php echo e($project->progress_percentage); ?>%</div>
                        </div>

                        <div>
                            <div class="proj-badge <?php echo e($statusClass); ?>"><?php echo e($project->status_label ?? 'Planning'); ?></div>
                        </div>
                    </div>
        ...
        <div>
            ...
            <div class="dash-card" style="margin-bottom: 24px;">
                ...
                <div class="donut-chart-container">
                    <div class="donut-chart" style="background: conic-gradient(#4d7c53 0% <?php echo e($overallProgress['percentage']); ?>%, #f3f4f6 <?php echo e($overallProgress['percentage']); ?>% 100%);">
                        <div class="donut-inner"><?php echo e($overallProgress['percentage']); ?>%</div>
                    </div>
                    <div class="donut-legend">
                        <div class="legend-item">
                            <div class="legend-title"><div class="legend-dot green"></div> On Track</div>
                            <div class="legend-sub"><?php echo e($overallProgress['on_track']); ?> Projects</div>
                        </div>
                        <div class="legend-item" style="margin-bottom: 0;">
                            <div class="legend-title"><div class="legend-dot orange"></div> Delayed</div>
                            <div class="legend-sub"><?php echo e($overallProgress['delayed']); ?> Projects</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="dash-card">
                <div class="dash-card-header">
                    ...
                    <a href="<?php echo e(route('admin.reports.index')); ?>" class="dash-card-link">View all reports &rarr;</a>
                </div>
                ...
                <div class="reports-list">
                    <?php $__empty_1 = true; $__currentLoopData = $recentReports ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="report-list-item" onclick="window.location.href='<?php echo e(route('admin.reports.index')); ?>'" style="cursor: pointer;">
                            <div class="report-info">
                                <div class="report-title"><?php echo e($report->title); ?></div>
                                <div class="report-meta"><?php echo e($report->project_name); ?> &middot; <?php echo e($report->phase_name); ?></div>
                            </div>
                            <div class="report-meta-right">
                                <span class="report-badge <?php echo e($report->status_class); ?>"><?php echo e($report->status_label); ?></span>
                                <div class="report-date"><?php echo e($report->submitted_at); ?></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg rounded-4" style="background: #ffffff;">
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-2 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.projects.index')); ?>" id="viewFullProjectBtn" class="btn btn-success px-4 shadow-sm fw-medium rounded-2 d-flex align-items-center gap-2" style="height: 40px; font-size: 0.88rem; text-decoration: none;">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>