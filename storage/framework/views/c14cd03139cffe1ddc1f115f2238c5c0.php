<?php $__env->startSection('title', 'Supervisor Profile - Account Settings'); ?>
<?php $__env->startSection('page_title', 'Supervisor Profile'); ?>
...
<div class="container-fluid px-0 supervisor-profile-page">
            ...
            <div class="ui-card profile-personal-card">
                ...
                <div class="d-flex flex-column flex-sm-row gap-4 align-items-start">
                    <div class="ui-avatar-container">
                        <div class="ui-avatar-large d-flex align-items-center justify-content-center text-white overflow-hidden" style="background: linear-gradient(135deg, #2F6B3C, #66BB6A); font-size: 2.5rem; font-weight: bold;">
                            <?php if($user->profile_photo): ?>
                                <img data-profile-photo src="<?php echo e(asset('storage/' . ltrim($user->profile_photo, '/'))); ?>" alt="Profile photo" class="w-100 h-100 object-fit-cover">
                            <?php else: ?>
                                <img data-profile-photo src="" alt="Profile photo" class="w-100 h-100 object-fit-cover d-none">
                                <span data-profile-initial><?php echo e(strtoupper(substr($user->name ?? 'S', 0, 1))); ?></span>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="flex-grow-1 profile-summary-content">
                        <h4 class="fw-bold mb-1"><?php echo e($user->name ?? 'Supervisor Name'); ?></h4>
                        <span class="badge badge-role rounded-pill mb-3"><?php echo e($userPosition); ?></span>
                        
                        <ul class="summary-list">
                            <li>
                                <i class="bi bi-card-text"></i>
                                <span class="label">Employee ID</span>
                                <span class="value"><?php echo e($employeeId); ?></span>
                            </li>
                            <li>
                                <i class="bi bi-envelope"></i>
                                <span class="label">Email Address</span>
                                <span class="value"><?php echo e($user->email ?? 'N/A'); ?></span>
                            </li>
                            <li>
                                <i class="bi bi-telephone"></i>
                                <span class="label">Phone Number</span>
                                <span class="value"><?php echo e($user->contact_number ?? '+63 912 345 6789'); ?></span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span class="value"><?php echo e(optional($user->created_at)->format('M j, Y') ?? 'N/A'); ?></span>
                            </li>
                            <li>
                                <i class="bi bi-check-circle-fill text-success"></i>
                                <span class="label">Account Status</span>
                                <span class="badge bg-success bg-opacity-10 text-success rounded px-2 py-1"><?php echo e($user->is_active ? 'Active' : 'Inactive'); ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="ui-card d-flex flex-column justify-content-between">
                <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between text-muted small profile-security-last-login">
                        <div>
                            <span class="fw-semibold text-dark"><?php echo e($lastLogin); ?></span>
                            <span class="mx-2">•</span>
                            <span><?php echo e($lastLoginTime); ?></span>
                        </div>
                        <div>
    ...
    <div class="row g-4 profile-main-grid">
            ...
            <div class="ui-card">
                ...
                <div class="info-grid mb-4">
                    <div class="info-row">
                        ...
                        <div class="info-item-value"><?php echo e($user->first_name ?? 'N/A'); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="info-item-label">Last Name</div>
                        <div class="info-item-value"><?php echo e($user->last_name ?? 'N/A'); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="info-item-label">Email Address</div>
                        <div class="info-item-value"><?php echo e($user->email ?? 'N/A'); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="info-item-label">Phone Number</div>
                        <div class="info-item-value"><?php echo e($user->contact_number ?? 'Not available'); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="info-item-label">Address</div>
                        <div class="info-item-value"><?php echo e($profileAddress); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="info-item-label">Position</div>
                        <div class="info-item-value"><?php echo e($userPosition); ?></div>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-item-value"><?php echo e($employeeId); ?></div>
                    </div>
                </div>
                ...
                <div class="pt-2">
                    ...
                    <div class="row g-3 text-center text-sm-start profile-related-grid">
                        <div class="col-12 col-sm-4">
                            ...
                            <div class="info-item-value"><?php echo e($assignedProjectName); ?></div>
                        </div>
                        <div class="col-12 col-sm-4">
        ...
        <div class="col-12 col-lg-4 d-flex flex-column gap-4">
            <div class="ui-card text-center py-4 profile-photo-card">
                ...
                <div class="px-3">
                    <form id="profilePhotoForm" action="<?php echo e(route('supervisor.profile.photo')); ?>" method="POST" enctype="multipart/form-data" class="mb-2">
                        <?php echo csrf_field(); ?>
            ...
            <div class="ui-card">
                ...
                <div class="d-flex flex-column">
                    <a href="<?php echo e(route('supervisor.notifications')); ?>" class="quick-link-item">
                    ...
                    <a href="<?php echo e(route('supervisor.profile')); ?>" class="quick-link-item">
                        <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="<?php echo e(route('supervisor.timeline')); ?>" class="quick-link-item">
                        <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="<?php echo e(route('supervisor.reports')); ?>" class="quick-link-item">
                        <div class="d-flex align-items-center gap-3">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center mt-5 pt-3 border-top text-muted small">
        <p class="mb-1 mb-sm-0">&copy; <?php echo e(date('Y')); ?> D&G Construction Management System. All rights reserved.</p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="profileUpdateForm" class="profile-modal-form" action="<?php echo e(route('supervisor.profile.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="first_name" class="form-label">First Name</label>
                            <input type="text" name="first_name" id="first_name" value="<?php echo e(old('first_name', $firstName)); ?>" class="form-control <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="last_name" id="last_name" value="<?php echo e(old('last_name', $lastName)); ?>" class="form-control <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="contact_number" id="contact_number" value="<?php echo e(old('contact_number', $user->contact_number)); ?>" class="form-control <?php $__errorArgs = ['contact_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($showAddressField): ?>
                        <div class="col-md-6">
                            <label for="address" class="form-label">Address</label>
                            <input type="text" name="address" id="address" value="<?php echo e(old('address', $user->address)); ?>" class="form-control <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<div class="modal fade" id="passwordModal" tabindex="-1" aria-labelledby="passwordModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="passwordUpdateForm" action="<?php echo e(route('supervisor.profile.password')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <?php if($errors->any()): ?>
            const hasPasswordErrors = <?php echo json_encode($errors->has('current_password') || $errors->has('password') || $errors->has('password_confirmation'), 15, 512) ?>;
            const hasProfileErrors = <?php echo json_encode($errors->has('name') || $errors->has('email') || $errors->has('contact_number') || $errors->has('address'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\resources\views\supervisor\profile.blade.php ENDPATH**/ ?>