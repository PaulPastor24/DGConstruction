<?php $__env->startSection('title', $project->project_name . ' - Client Portal'); ?>
<?php $__env->startSection('mobileTitle', $project->project_name); ?>
        ...
        <div class="row g-4">
            <div class="col-12 col-lg-7">
                <div class="project-detail-banner">
                    <img src="<?php echo e($detailImage); ?>" alt="<?php echo e($project->project_name); ?> overview image">
                </div>
            </div>
            <div class="col-12 col-lg-5">
                <div class="project-detail-info">
                    <div class="detail-pill"><?php echo e($project->status === 'ongoing' ? 'In Progress' : ucfirst($project->status)); ?></div>
                    <div class="detail-location"><i class="bi bi-geo-alt me-2"></i><?php echo e($detailLocation !== '' ? $detailLocation : 'Location Pending'); ?></div>
                    <div class="detail-metric"><span>Start</span><strong><?php echo e($project->start_date?->format('M d, Y') ?? 'TBD'); ?></strong></div>
                    <div class="detail-metric"><span>Target End</span><strong><?php echo e($project->target_end_date?->format('M d, Y') ?? 'TBD'); ?></strong></div>
                    <div class="detail-metric"><span>Manager</span><strong><?php echo e(optional($project->engineer)->name ?? 'Unassigned'); ?></strong></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mt-1">
        <div class="col-12 col-lg-8">
            <div class="detail-panel">
                ...
                <div class="phase-list">
                    <?php $__currentLoopData = $project->phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="phase-item">
                            <div class="phase-item-top">
                                <span><?php echo e($phase->phase_name); ?></span>
                                <span class="phase-percent"><?php echo e((int) ($phase->completion_percentage ?? 0)); ?>%</span>
                            </div>
                            <div class="progress" style="height:8px; background:#e2e8f0; border-radius:999px;">
                                <div class="progress-bar bg-success" style="width: <?php echo e($phase->completion_percentage ?? 0); ?>%;"></div>
                            </div>
                        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="detail-panel">
                ...
                <div class="summary-stat"><span>Current Phase</span><strong><?php echo e(optional($project->phases->firstWhere('status','in_progress'))->phase_name ?? 'N/A'); ?></strong></div>
                <div class="summary-stat"><span>Overall Completion</span><strong><?php echo e(round($project->phases->avg('completion_percentage') ?? 0)); ?>%</strong></div>
                <div class="summary-stat"><span>Supervisor</span><strong><?php echo e(optional($project->activeSupervisor)->name ?? 'Not assigned'); ?></strong></div>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\client\project-details.blade.php ENDPATH**/ ?>