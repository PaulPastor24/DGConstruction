<?php $__env->startSection('title', 'Project Management - D&G Construction Monitor'); ?>
<?php $__env->startSection('page_title', 'Project Management'); ?>
...
<div class="mi-page inventory-green-theme main-dashboard-container">
    ...
    <div class="left-dashboard-content">
        ...
        <div class="metrics-row-grid">
            <div class="metric-card-box total">
                ...
                <div class="metric-info-text">
                    ...
                    <div class="stat-num"><?php echo e($stats['total'] ?? 8); ?></div>
            ...
            <div class="metric-card-box progress-active">
                ...
                <div class="metric-info-text">
                    ...
                    <div class="stat-num"><?php echo e($stats['ongoing'] ?? 5); ?></div>
            ...
            <div class="metric-card-box hold">
                ...
                <div class="metric-info-text">
                    ...
                    <div class="stat-num"><?php echo e($stats['on_hold'] ?? 1); ?></div>
            ...
            <div class="metric-card-box completed">
                ...
                <div class="metric-info-text">
                    ...
                    <div class="stat-num"><?php echo e($stats['completed'] ?? 2); ?></div>
        ...
        <div class="filter-toolbar-panel">
            <form id="project-filters-form" method="GET" action="<?php echo e(route('admin.projects.index')); ?>" class="filter-form-row">
                <div class="search-input-container">
                    <i class="bi bi-search search-icon"></i>
                    <input type="search" name="search" value="<?php echo e(request('search')); ?>" class="form-control form-control-sm" placeholder="Search projects...">
                </div>
                ...
                <select name="status" class="form-select filter-dropdown-select form-select-sm">
                    ...
                    <option value="ongoing" <?php echo e(request('status') == 'ongoing' ? 'selected' : ''); ?>>In Progress</option>
                ...
                <select name="client" class="form-select filter-dropdown-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($client->client_id); ?>" <?php echo e(request('client') == $client->client_id ? 'selected' : ''); ?>>
                            <?php echo e($client->user->name ?? 'Unknown Client'); ?>
                ...
                <select name="supervisor" class="form-select filter-dropdown-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($supervisor->user_id); ?>" <?php echo e(request('supervisor') == $supervisor->user_id ? 'selected' : ''); ?>>
                ...
                <select name="sort_by" class="form-select filter-dropdown-select form-select-sm" aria-label="Sort projects">
                    ...
                    <option value="oldest" <?php echo e(request('sort_by') == 'oldest' ? 'selected' : ''); ?>>Oldest</option>
                    <option value="name_asc" <?php echo e(request('sort_by') == 'name_asc' ? 'selected' : ''); ?>>Title A-Z</option>
                    <option value="name_desc" <?php echo e(request('sort_by') == 'name_desc' ? 'selected' : ''); ?>>Title Z-A</option>
                </select>
        ...
        <?php echo $__env->make('admin.projects.partials.table', ['projects' => $projects], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="row g-2 align-items-end mb-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select id="projectArchiveClientFilter" class="form-select">
                            <option value="">All Clients</option>
                            <?php $__currentLoopData = ($archiveClients ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <option value="<?php echo e($client->client_id); ?>"><?php echo e($clientOptionLabel); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-12 col-md-4">
                        ...
                        <select id="projectArchiveEngineerFilter" class="form-select">
                            ...
                            <?php $__currentLoopData = ($archiveEngineers ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $engineer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <option value="<?php echo e($engineer->user_id); ?>"><?php echo e($engineerOptionLabel); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="table-responsive rounded-3 border overflow-hidden">
                    <table class="table align-middle mb-0">
                        ...
                        <tbody id="projectArchivesTableBody">
                            <?php $__empty_1 = true; $__currentLoopData = $archives ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="archive-row"
                                    data-client-id="<?php echo e($archive->client_id ?: ''); ?>"
                                    data-engineer-id="<?php echo e($archive->engineer_id ?: ''); ?>"
                                    data-search="<?php echo e(trim(strtolower(($archive->project_name ?? '') . ' ' . ($archive->project_location ?: '') . ' ' . ($archive->client?->company_name ?: '') . ' ' . ($archive->client?->user?->first_name ?: '') . ' ' . ($archive->client?->user?->last_name ?: '') . ' ' . ($archive->engineer?->first_name ?: '') . ' ' . ($archive->engineer?->last_name ?: '') . ' ' . ($archive->engineer?->name ?: '')))); ?>">
                                    <td>
                    ...
                    <div class="modal-section-card">
                        ...
                        <div class="modal-grid-1">
                            <div>
                                ...
                                <input type="text"
                                       class="form-control modal-custom-input w-100 <?php $__errorArgs = ['project_name'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea class="form-control modal-custom-input w-100 <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="file"
                                       class="form-control modal-custom-input w-100 <?php $__errorArgs = ['project_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="modal-grid-2">
                                <div>
                                    ...
                                    <input type="text"
                                           class="form-control modal-custom-input w-100 <?php $__errorArgs = ['project_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select class="form-select modal-custom-input w-100 <?php $__errorArgs = ['client_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="modal-section-card">
                        ...
                        <div class="modal-grid-2">
                            <div>
                                ...
                                <input type="date"
                                       class="form-control modal-custom-input w-100 <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date"
                                       class="form-control modal-custom-input w-100 <?php $__errorArgs = ['target_end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="modal-grid-2 mt-3">
                            <div>
                                ...
                                <input type="date"
                                       class="form-control modal-custom-input w-100 <?php $__errorArgs = ['actual_end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select class="form-select modal-custom-input w-100 <?php $__errorArgs = ['supervisor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<div class="modal fade" id="editProjectModal" tabindex="-1" aria-labelledby="editProjectModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 px-2 py-1" style="border-radius: 16px; box-shadow: 0 18px 45px rgba(15, 23, 42, 0.16);">
            ...
            <div class="modal-body pt-2 px-4 pb-4">
                <form action="<?php echo e(old('project_id', session('edit_project_id')) ? route('admin.projects.update', ['project' => old('project_id', session('edit_project_id'))]) : route('admin.projects.index')); ?>" method="POST" id="editProjectForm" class="edit-project-form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="project_id" id="editProjectId" value="<?php echo e(old('project_id', session('edit_project_id', ''))); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-3">
                            ...
                            <select class="form-select modal-custom-input w-100 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="edit_status" name="status" required>
                                <option value="planning" <?php echo e(old('status', '') == 'planning' ? 'selected' : ''); ?>>Planning</option>
                                <option value="ongoing" <?php echo e(old('status', '') == 'ongoing' ? 'selected' : ''); ?>>In Progress</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-3 d-none" id="editHoldReasonGroup">
                            ...
                            <textarea class="form-control modal-custom-input w-100 <?php $__errorArgs = ['hold_reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      rows="2"
                                      maxlength="2000"
                                      placeholder="Explain why construction is temporarily stopped"><?php echo e(old('hold_reason', '')); ?></textarea>
                            <?php $__errorArgs = ['hold_reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php if((session('show_create_success_modal') || session('show_success_modal')) && isset($newProject) && $newProject): ?>
    <?php
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="ps-body">
                        ...
                        <div class="ps-overview-card">
                            <div class="ps-overview-top">
                                <div class="ps-overview-identity">
                                    ...
                                    <div>
                                        <div class="ps-overview-name"><?php echo e($newProject->project_name); ?></div>
                                        <div class="ps-overview-id">ID: #<?php echo e($newProject->project_id); ?></div>
                                    </div>
                                </div>
                                <div class="ps-overview-status">
                                    <span class="ps-field-label">Status</span>
                                    <span class="ps-status-pill <?php echo e($newProject->status === 'on_hold' ? 'warning' : 'success'); ?>">
                                        <i class="bi bi-<?php echo e($newProject->status === 'on_hold' ? 'pause-circle' : 'check-circle'); ?>"></i>
                                        <?php echo e($newProject->workflow_status_label ?? ucfirst($newProject->status)); ?>
                            ...
                            <div class="ps-detail-grid">
                                <div>
                                    ...
                                    <div class="ps-field-value"><?php echo e($newProject->description ?: 'Not provided'); ?></div>
                                </div>
                                <div>
                                    <div class="ps-field-label">Start Date</div>
                                    <div class="ps-field-value"><i class="bi bi-calendar3"></i> <?php echo e($psStart ? $psStart->format('M d, Y') : 'Not set'); ?></div>
                                </div>
                                <div>
                                    <div class="ps-field-label">Target End Date</div>
                                    <div class="ps-field-value"><i class="bi bi-calendar3"></i> <?php echo e($psTargetEnd ? $psTargetEnd->format('M d, Y') : 'Not set'); ?></div>
                                </div>
                                <div>
                                    <div class="ps-field-label">Created</div>
                                    <div class="ps-field-value"><i class="bi bi-calendar3"></i> <?php echo e($newProject->created_at ? $newProject->created_at->format('M d, Y h:i A') : 'N/A'); ?></div>
                                </div>
                                <div>
                                    <div class="ps-field-label">Location</div>
                                    <div class="ps-field-value"><?php echo e($newProject->location ?? 'Not specified'); ?></div>
                                </div>
                                <div>
                                    <div class="ps-field-label">Actual End Date</div>
                                    <div class="ps-field-value <?php echo e($psActualEnd ? '' : 'ps-muted-danger'); ?>">
                                        <i class="bi bi-clock-history"></i> <?php echo e($psActualEnd ? $psActualEnd->format('M d, Y') : 'Not completed'); ?>

                                    </div>
                                </div>
                                <div>
                                    <div class="ps-field-label">Duration</div>
                                    <div class="ps-field-value"><i class="bi bi-clock-history"></i> <?php echo e($psDuration > 0 ? $psDuration . ' days' : 'Not available'); ?></div>
                                </div>
                            </div>
                        </div>

                        <div class="ps-actions-grid">
                            <a href="<?php echo e(route('admin.phases', ['project_id' => $newProject->project_id])); ?>" class="ps-action-card">
                                <p class="ps-action-title"><i class="bi bi-plus-lg"></i>Add Phases</p>
                                <p class="ps-action-copy">Define construction phases</p>
                            </a>
                            <?php if($newProject->phase_count > 0): ?>
                                <a href="<?php echo e(route('admin.timeline')); ?>?project_id=<?php echo e($newProject->project_id); ?>" class="ps-action-card" id="ps-timeline-link">
                        ...
                        <div>
                            ...
                            <div class="ps-mini-grid">
                                ...
                                <div class="ps-mini-card">
                                    <div class="ps-mini-icon <?php echo e($psActiveSupervisor ? 'success' : 'warning'); ?>">
                                        <i class="bi bi-<?php echo e($psActiveSupervisor ? 'check-lg' : 'exclamation-lg'); ?>"></i>
                                    </div>
                                    <div class="ps-mini-label">Supervisor Assigned</div>
                                    <span class="ps-status-pill <?php echo e($psActiveSupervisor ? 'success' : 'warning'); ?>">
                                        <i class="bi bi-<?php echo e($psActiveSupervisor ? 'check-circle' : 'exclamation-circle'); ?>"></i>
                                        <?php echo e($psActiveSupervisor ? 'Assigned' : 'Pending'); ?>
                                ...
                                <div class="ps-mini-card">
                                    ...
                                    <div class="ps-mini-value"><?php echo e($newProject->phase_count); ?> Current Count</div>
                                </div>
                                <div class="ps-mini-card">
                                    <div class="ps-mini-icon neutral"><i class="bi bi-flag"></i></div>
                                    <div class="ps-mini-label">Timeline Milestones</div>
                                    <div class="ps-mini-value"><?php echo e($newProject->milestone_count); ?> Current Count</div>
                                </div>
                                <?php if (! ($psSetupReady)): ?>
                    ...
                    <div class="ps-footer">
                        <a href="<?php echo e(route('admin.projects.index')); ?>" class="btn btn-dg-primary btn-sm">Close</a>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function buildAdminProjectsUrl(projectId) {
        if (!projectId) return '<?php echo e(route('admin.projects.index')); ?>';
    ...
    function syncEditProjectFormAction(projectId) {
        ...
        if (projectId) {
            ...
            editProjectForm.action = '<?php echo e(route('admin.projects.index')); ?>';
        }
    }
    ...
    const editProjectIdFromSession = <?php echo json_encode(session('edit_project_id', ''), 512) ?>;
    ...
    const flashSuccessMessage = <?php echo json_encode(session('success'), 15, 512) ?>;
    const flashErrorMessage = <?php echo json_encode(session('error'), 15, 512) ?>;
    const flashInfoMessage = <?php echo json_encode(session('info'), 15, 512) ?>;
    const flashSuccessTitle = <?php echo json_encode(session('success_title'), 15, 512) ?>;
    const flashErrorTitle = <?php echo json_encode(session('error_title', 'Project update failed'), 512) ?>;
    const showCreateSuccessModal = <?php echo json_encode((bool) session('show_create_success_modal', false), 512) ?>;
    const showEditProjectModal = <?php echo json_encode((bool) session('show_edit_project_modal', false), 512) ?>;
    ...
    if (projectSuccessModalEl && window.bootstrap && typeof window.bootstrap.Modal === 'function') {
        ...
        if (psTimelineLink) {
            psTimelineLink.addEventListener('click', function (event) {
                const hasPhases = <?php echo e(isset($newProject) && $newProject && $newProject->phase_count > 0 ? 'true' : 'false'); ?>;
                if (!hasPhases) {
                    event.preventDefault();
                    if (window.Swal) {
                        Swal.fire({
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views/admin/projects/index.blade.php ENDPATH**/ ?>