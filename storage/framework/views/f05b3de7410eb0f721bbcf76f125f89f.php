<?php $__env->startSection('title', 'Client Portal - Project Progress Dashboard'); ?>
<?php $__env->startSection('mobileTitle', 'Dashboard'); ?>
...
<div class="container-fluid p-0">
    ...
    <div class="hero-card mb-4"
         ...
         data-carousel-projects='<?php echo json_encode($carouselProjects, 15, 512) ?>'
         data-carousel-index="<?php echo e($primaryProjectIndex); ?>"
         data-snapshot-url-template="<?php echo e(url('/client/dashboard/project/__ID__/snapshot')); ?>">
        <div class="row align-items-center g-0">
            <div class="col-md-7 p-3 p-lg-4 hero-content">
                <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                    <span class="badge-project-status">CURRENT PROJECT</span>
                    <span class="project-status-pill <?php echo e($stats['delayed_milestones_count'] > 0 ? 'status-delayed' : 'status-on-track'); ?>" id="heroStatusPill"><?php echo e($stats['delayed_milestones_count'] > 0 ? 'Delayed' : 'On Track'); ?></span>
                </div>
                ...
                <div class="project-title-carousel"
                    ...
                    <div class="carousel-track" id="carouselTrack">
                        ...
                        <h1 class="carousel-slide carousel-slide-current project-title-text" id="carouselSlideCurrent" aria-live="polite"><?php echo e($primaryProject?->project_name ?? ''); ?></h1>
                ...
                <p class="project-subtitle-text text-muted mb-2" id="heroLocationText"><?php echo e($primaryLocation !== '' ? $primaryLocation : 'Location Pending'); ?></p>

                <div class="row mt-2 g-2">
                    <div class="col-6 col-sm-3">
                        <div class="meta-label"><i class="bi bi-calendar-check me-1"></i> Project Start</div>
                        <div class="meta-value" id="heroStartDate"><?php echo e($primaryProject?->start_date?->format('M d, Y') ?? 'TBD'); ?></div>
                    </div>
                    <div class="col-6 col-sm-3">
                        <div class="meta-label"><i class="bi bi-calendar-x me-1"></i> Est. Completion</div>
                        <div class="meta-value" id="heroEndDate"><?php echo e($primaryProject?->target_end_date?->format('M d, Y') ?? 'TBD'); ?></div>
                    </div>
                    <div class="col-6 col-sm-3">
                        <div class="meta-label"><i class="bi bi-person-workspace me-1"></i> Project Manager</div>
                        <div class="meta-value" id="heroManager"><?php echo e($primaryProject?->engineer?->name ?? 'Unassigned'); ?></div>
                    </div>
                    <div class="col-6 col-sm-3">
                        <div class="meta-label"><i class="bi bi-building-gear me-1"></i> Site Supervisor</div>
                        <div class="meta-value" id="heroSupervisor"><?php echo e($primaryProject?->activeSupervisor?->name ?? 'Not assigned'); ?></div>
                    </div>
                </div>
                ...
                <div class="project-progress-embedded mt-3">
                    <div class="project-progress-header">
                        ...
                        <span class="project-progress-value" id="heroProgressValue"><?php echo e($stats['overall_completion']); ?>%</span>
                    </div>
                    <div class="project-progress-track" aria-label="Project completion progress bar">
                        <span id="heroProgressBar" style="width: <?php echo e($stats['overall_completion']); ?>%"></span>
                    </div>
                    <div class="project-progress-meta">
                        <span><i class="bi bi-flag-fill me-1"></i><span id="heroPhaseText"><?php echo e($currentPhaseName); ?></span><span class="ms-1 text-muted" id="heroPhaseStatus">(<?php echo e($currentPhaseStatus); ?>)</span></span>
                    </div>
                </div>
            </div>
            <div class="col-md-5 d-none d-md-flex structural-img-container align-items-center justify-content-center">
                <div class="hero-image-wrap">
                    <img id="heroProjectImage"
                         src="<?php echo e($primaryProject?->image_url ?? 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1600&q=80'); ?>"
                         alt="<?php echo e($primaryProject?->project_name ?? 'Project'); ?> image"
    ...
    <div class="row g-3 mb-4" id="dashboardMetricsRow">
            ...
            <div class="metric-status-card">
                ...
                <div>
                    ...
                    <div class="metric-main-val text-success" id="metricCurrentPhase" style="font-size: 1.25rem; font-weight:700; margin: 0.3rem 0;">
                        <?php echo e(optional($currentPhases->first())->phase_name ?? 'Structural Works'); ?>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="metric-status-card">
                <div class="metric-icon-box bg-mint-light"><i class="bi bi-shield-check <?php echo e($scheduleHealthClass); ?>" id="metricScheduleHealthIcon"></i></div>
                <div>
                    <div class="metric-title">Schedule Health</div>
                    <span class="metric-status-pill <?php echo e($scheduleHealth === 'At Risk' ? 'status-delayed' : 'status-on-track'); ?>" id="metricScheduleHealthPill"><?php echo e($scheduleHealth); ?></span>
                    <div class="metric-sub-text" id="metricScheduleHealthNote"><?php echo e($scheduleHealthNote); ?></div>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="metric-status-card">
                ...
                <div>
                    ...
                    <div class="metric-main-val text-success" id="metricNextMilestoneName" style="font-size: 1.05rem; font-weight:700; line-height:1.2; margin:0.25rem 0;">
                        <?php echo e(optional($nextMilestone)->milestone_name ?? 'Next milestone pending'); ?>

                    </div>
                    <div class="metric-sub-text text-dark fw-semibold" id="metricNextMilestoneDate"><?php echo e(optional($nextMilestone?->end_date ?? $nextMilestone?->start_date)->format('M d, Y') ?? 'Pending'); ?></div>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="metric-status-card">
                ...
                <div>
                    ...
                    <div class="metric-main-val text-success" id="metricLatestReportStatus" style="font-size: 1.25rem; font-weight:700; margin: 0.3rem 0;">
                        <?php echo e(match($stats['latest_report_status'] ?? null) {
                    ...
                    <div class="metric-sub-text" id="metricLatestReportNote"><?php echo e($stats['latest_report_note'] ?? 'No report submitted'); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-md-7 col-xl-8">
            <div class="dashboard-ui-panel">
                <div class="ui-panel-head d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('client.reports')); ?>" class="view-all-link">View All</a>
                </div>
                <div class="ui-panel-body p-0">
                    <div class="report-list-group" id="recentReportsList">
                        <?php $__empty_1 = true; $__currentLoopData = $recentReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="report-item-row <?php echo e($loop->iteration > 3 ? 'dashboard-extra-item d-none' : ''); ?>">
                                <div class="d-flex align-items-start gap-3">
                                    <div class="file-icon-frame"><i class="bi bi-file-earmark-text"></i></div>
                                    <div>
                                        <h6><?php echo e(optional($report->phase)->phase_name ?? 'Project Update'); ?></h6>
                                        <p><?php echo e(Str::limit($report->report_text ?? 'Report available', 48)); ?> &bull; <?php echo e(optional($report->report_date)->format('M d, Y') ?? 'Unknown'); ?></p>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('client.reports.downloadPdf', $report->report_id)); ?>" class="download-icon-btn" title="Download report"><i class="bi bi-download"></i></a>
                            </div>
        ...
        <div class="col-12 col-md-5 col-xl-4">
            <div class="dashboard-ui-panel">
                <div class="ui-panel-head d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('client.notifications')); ?>" class="view-all-link">View All</a>
                </div>
                <div class="ui-panel-body">
                    <div class="activity-timeline-container" id="recentActivityList">
                        <?php $__empty_1 = true; $__currentLoopData = $activityItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="activity-timeline-node <?php echo e($loop->iteration > 3 ? 'dashboard-extra-item d-none' : ''); ?>">
                                <div class="node-icon <?php echo e($item['variant']); ?>">
                                    <i class="<?php echo e($item['icon']); ?>"></i>
                                </div>
                                <div class="node-content">
                                    <div class="d-flex justify-content-between align-items-baseline gap-2">
                                        <h6 class="activity-node-title mb-1"><?php echo e($item['title']); ?></h6>
                                        <span class="node-time flex-shrink-0"><?php echo e($item['time']); ?></span>
                                    </div>
                                    <p class="activity-node-desc mb-0"><?php echo e($item['subtitle']); ?> &bull; <span class="text-dark fw-medium"><?php echo e($item['author']); ?></span></p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="text-center p-4 text-muted">
...
<script>
    function initClientDashboardCarousel() {
        ...
        const SELECT_PROJECT_URL_TEMPLATE = "<?php echo e(route('client.dashboard.project.select', ['project' => '__ID__'])); ?>";
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0">
                <div>
                    <h5 class="modal-title fw-bold" id="projectOverviewModalLabel"><?php echo e(optional($primaryProject)->project_name ?? 'Project details'); ?></h5>
                ...
                <div class="row g-3">
                    <div class="col-12 col-sm-6">
                        <div class="border rounded-3 p-3">
                            ...
                            <div class="fw-bold fs-4 text-success"><?php echo e($stats['overall_completion']); ?>%</div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="border rounded-3 p-3">
                            <div class="text-muted small text-uppercase">Current phase</div>
                            <div class="fw-bold"><?php echo e($currentPhaseName); ?></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="border rounded-3 p-3">
                            <div class="text-muted small text-uppercase">Next milestone</div>
                            <div class="fw-bold"><?php echo e($nextMilestoneName); ?></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="border rounded-3 p-3">
                            <div class="text-muted small text-uppercase">Assigned manager</div>
                            <div class="fw-bold"><?php echo e(optional(optional($primaryProject)->engineer)->name ?? 'Unassigned'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer border-0 flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('client.timeline')); ?>" class="project-command-button-primary">View Timeline</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\resources\views\client\dashboard.blade.php ENDPATH**/ ?>