        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="metric-status-card">
                ...
                <div>
                    ...
                    <div class="metric-sub-text text-dark fw-semibold" id="metricNextMilestoneDate"><?php echo e(optional($nextMilestone)->start_date?->format('M d, Y') ?? 'Pending'); ?></div>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="metric-status-card">
                ...
                <div>
                    ...
                    <div class="metric-main-val text-success" id="metricLatestReportStatus" style="font-size: 1.25rem; font-weight:700; margin: 0.3rem 0;">
                        <?php echo e($recentReports->first()?->approval_status === 'approved' && $recentReports->first()?->is_published_to_client ? 'Published' : ($recentReports->first()?->approval_status === 'rejected' ? 'Returned' : 'No report')); ?>

                    </div>
                    <div class="metric-sub-text" id="metricLatestReportNote"><?php echo e($recentReports->count() > 0 ? 'Last uploaded report' : 'No report submitted'); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\client\dashboard.blade.php ENDPATH**/ ?>