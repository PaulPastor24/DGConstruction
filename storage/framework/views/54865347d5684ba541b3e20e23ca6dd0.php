    ...
    <main>
        ...
        <section class="hero" id="top">
            ...
            <div class="hero-visual">
                <?php if($galleryImages->first()): ?>
                    <img src="<?php echo e(asset('storage/' . ltrim($galleryImages->first()->image_path, '/'))); ?>" alt="<?php echo e($galleryImages->first()->project->project_name); ?>">
                <?php else: ?>
                    <img src="<?php echo e(asset('images/bg.png')); ?>" alt="D&G Construction Inc.">
                <?php endif; ?>
            </div>
        </section>
                ...
                <div class="project-carousel-track">
                    <?php $__empty_1 = true; $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleryImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <article class="project-card">
                            <button type="button" class="project-card-trigger js-open-gallery-project" data-project-url="<?php echo e(route('landing-gallery.projects.show', $galleryImage->project)); ?>" aria-label="View details for <?php echo e($galleryImage->project->project_name); ?>">
                                ...
                                <div class="project-body">
                                    <h3><?php echo e($galleryImage->project->project_name); ?></h3>
                                    <p><?php echo e($galleryImage->project->location ?: 'Completed project'); ?></p>
                                </div>
...
</html><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\welcome.blade.php ENDPATH**/ ?>