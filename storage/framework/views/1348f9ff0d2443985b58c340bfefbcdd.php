...
<body style="font-family: Arial, sans-serif; color: #1f2937;">
    ...
    <table cellpadding="8" cellspacing="0" border="1" style="border-collapse: collapse; width: 100%;">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <tr>
                <td><?php echo e($workerName); ?></td>
                <td><?php echo e($projectName); ?></td>
                <td><?php echo e(\Carbon\Carbon::parse($scheduleStart)->format('g:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($scheduleEnd)->format('g:i A')); ?></td>
                <td><?php echo e($record->time_in ?: '-'); ?></td>
                <td><?php echo e($record->time_out ?: '-'); ?></td>
...
<?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\emails\daily-attendance-report.blade.php ENDPATH**/ ?>