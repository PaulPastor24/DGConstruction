...
<?php $__env->startSection('mobileTitle', 'Reports'); ?>
...
<div class="container-fluid p-0 client-reports-page">
    <?php echo $__env->make('client.partials.page-header', [
        ...
        <form method="GET" id="filterForm" class="row g-3 align-items-end">
            <div class="col-12 col-md-3">
                ...
                <select name="project_id" id="projectSelect" class="form-select form-select-sm" onchange="this.form.submit()">
                    ...
                    ?>
                    <option value="" <?php echo e($selectedProjectFilter == '' || $selectedProjectFilter === null ? 'selected' : ''); ?>>All Projects</option>
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($project->project_id); ?>" <?php echo e((string) $selectedProjectFilter === (string) $project->project_id ? 'selected' : ''); ?>><?php echo e($project->project_name); ?></option>
            ...
            <div class="col-12 col-md-2">
                ...
                <select name="status" id="statusSelect" class="form-select form-select-sm" onchange="this.form.submit()">
                    ...
                    <option value="published" <?php echo e(request('status') == 'published' ? 'selected' : ''); ?>>Published to Client</option>
                </select>
            </div>
            <div class="col-12 col-md-2">
            ...
            <div class="col-12 col-md-2">
                ...
                <input type="date" name="report_date" id="reportDateInput" value="<?php echo e(request('report_date')); ?>" class="form-control form-control-sm" onchange="this.form.submit()" />
            </div>
        </form>
    </section>
        ...
        <div class="col-6 col-xl-3">
            <div class="report-summary-widget">
                ...
                <div>
                    ...
                    <h3><?php echo e($stats['published'] ?? $stats['total'] ?? 0); ?></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="report-main-panel mb-4">
        <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap justify-content-end">
                <?php if($selectedProject): ?>
                    <a href="<?php echo e(route('client.reports.imagesPdf', $selectedProject->project_id)); ?>" class="btn btn-sm report-export-btn" target="_blank">
                        <i class="bi bi-images me-1"></i> Export Images
                    </a>
                <?php endif; ?>
                <div class="badge rounded-pill bg-success-subtle text-success px-3 py-2"><?php echo e($reports->total()); ?> records</div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table report-custom-table align-middle mb-0">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="fw-bold text-dark"><?php echo e(optional($report->project)->project_name ?? 'Unknown Project'); ?></div>
                                <div class="text-muted small"><?php echo e(optional($report->project)->location ?? 'Project update'); ?></div>
                            </td>
                            <td>
                                <span class="text-dark fw-semibold"><?php echo e(optional($report->phase)->phase_name ?? 'Unassigned Phase'); ?></span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-pill"><?php echo e(strtoupper(substr(optional($report->submittedBy)->name ?? 'S', 0, 1))); ?></div>
                                    <div>
                            ...
                            <td>
                                <?php if($status): ?>
                                    <span class="status-pill <?php echo e($pillClass); ?>"><?php echo e($status === 'published' ? 'Published' : 'Returned'); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-end">
                                <div class="d-inline-flex gap-1">
                                    <button class="btn btn-sm btn-light border report-action-btn js-report-view-btn" type="button" data-report-details='<?php echo json_encode($detailPayload, 15, 512) ?>' data-modal-target="reportDetailsModal-<?php echo e($report->report_id); ?>" title="View details">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                    <a href="<?php echo e(route('client.reports.downloadPdf', $report->report_id)); ?>" target="_blank" data-report-id="<?php echo e($report->report_id); ?>" class="btn btn-sm btn-light border report-action-btn report-export-link" title="Export PDF">
                ...
                <div class="modal fade report-details-modal" id="reportDetailsModal-<?php echo e($report->report_id); ?>" data-gallery='<?php echo json_encode($detailPayload['site_images'] ?? [], 15, 512) ?>' tabindex="-1" aria-labelledby="reportDetailsModalLabel-<?php echo e($report->report_id); ?>" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header" style="background: #ffffff; border-bottom: 2px solid var(--cms-green-dark, #2a4028);">
                                        <div>
                                            <h5 class="modal-title fw-bold" id="reportDetailsModalLabel-<?php echo e($report->report_id); ?>" style="color: var(--cms-green-dark, #2a4028);">Report Details</h5>
                                                ...
                                                <div class="report-detail-card p-4">
                                                    <div class="d-flex flex-column flex-sm-row justify-content-between gap-3 mb-4 p-3 rounded-3" style="background: #fff;">
                                                        <div>
                                                            ...
                                                            <div class="fw-bold text-dark" style="font-size: 1.1rem;"><?php echo e($detailPayload['report_id']); ?></div>
                                                        </div>
                                                        <div class="text-sm-end">
                                                            <div class="small text-uppercase text-muted" style="font-weight: 600;">Approval Status</div>
                                                            <?php if($status): ?>
                                                                <span class="status-pill <?php echo e($pillClass); ?> p-2 mt-1 d-inline-block"><?php echo e($status === 'published' ? 'Published' : 'Returned'); ?></span>
                                                            <?php else: ?>
                                                                <span class="text-muted small">—</span>
                                                            <?php endif; ?>
                                                        </div>
                                                    ...
                                                    <div class="row g-3 mb-4 small">
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb; border-radius: 14px;">
                                                            ...
                                                            <div class="text-dark"><?php echo e($detailPayload['project']); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb; border-radius: 14px;">
                                                            <div class="fw-semibold text-muted mb-1">Construction Phase</div>
                                                            <div class="text-dark"><?php echo e($detailPayload['phase']); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb; border-radius: 14px;">
                                                            <div class="fw-semibold text-muted mb-1">Report Date</div>
                                                            <div class="text-dark"><?php echo e($detailPayload['submitted_at']); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb; border-radius: 14px;">
                                                            <div class="fw-semibold text-muted mb-1">Submitted By</div>
                                                            <div class="text-dark"><?php echo e($detailPayload['submitted_by']); ?></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="p-4 rounded-3 mb-4" style="white-space: pre-line; line-height: 1.7; background: #f9fafb; border-radius: 14px;">
                                                        ...
                                                        <p class="mb-0 text-dark small"><?php echo e($detailPayload['report_text']); ?></p>
                                                    </div>
                                                    ...
                                                    <div class="row g-3 mb-3">
                                                        <div class="col-12 col-md-6">
                                                            <div class="p-3 rounded-3" style="background: #f9fafb; border-radius: 14px;">
                                                                ...
                                                                <div class="text-dark"><?php echo e($detailPayload['reviewed_by']); ?></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <div class="p-3 rounded-3" style="background: #f9fafb; border-radius: 14px;">
                                                                 <div class="fw-semibold text-muted mb-1">Approved By</div>
                                                                 <div class="text-dark"><?php echo e($detailPayload['reviewed_by'] !== '-' ? $detailPayload['reviewed_by'] : '—'); ?></div>
                                                             </div>
                                                         </div>
                                                     </div>
                                                 </div>
                                             ...
                                             <div class="col-12 col-xl-5">
                                                <div class="report-detail-sidebar p-4">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        ...
                                                        <div class="small text-muted"><?php echo e(count($detailPayload['site_images'])); ?> uploaded</div>
                                                    </div>
                                                    <?php if(count($detailPayload['site_images']) === 0): ?>
                                                        <div class="text-muted small border rounded-3 p-3" style="background: #f9fafb;">No site images were attached to this report.</div>
                                                    <?php else: ?>
                                                        <div class="report-image-carousel" data-gallery='<?php echo json_encode($detailPayload['site_images'] ?? [], 15, 512) ?>'>
                                                    ...
                                                    <div class="d-flex justify-content-center" style="padding-top: 2rem; margin-top: 2rem; border-top: 2px solid rgba(42, 64, 40, 0.12);">
                                                        <a href="<?php echo e(route('client.reports.downloadPdf', $report->report_id)); ?>" target="_blank" class="btn btn-cms-primary report-export-link" data-report-id="<?php echo e($report->report_id); ?>">
                ...
                <article class="report-mobile-card">
                    <div class="report-mobile-topline">
                        <div class="report-mobile-date">
                            ...
                            <strong><?php echo e(optional($report->report_date)->format('M d, Y') ?? 'N/A'); ?></strong>
                            <small><?php echo e(optional($report->created_at)->format('h:i A') ?? ''); ?></small>
                        </div>
                        <?php if($status): ?>
                            <span class="status-pill <?php echo e($displayPillClass); ?>"><?php echo e($displayStatus === 'rejected' ? 'Returned' : 'Published'); ?></span>
                        <?php else: ?>
                            <span class="text-muted small">—</span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="report-mobile-main">
                        <h3><?php echo e($report->report_title ?? optional($report->phase)->phase_name ?? 'Accomplishment Report'); ?></h3>
                        <p><?php echo e(\Illuminate\Support\Str::limit(strip_tags($report->admin_report_text ?? $report->report_text ?? 'Latest accomplishment update submitted by the site supervisor.'), 90)); ?></p>
                    </div>

                    <div class="report-mobile-details">
                        <div class="report-mobile-detail-row">
                            <span>Project</span>
                            <strong><?php echo e(optional($report->project)->project_name ?? 'Unknown Project'); ?></strong>
                        </div>
                        <div class="report-mobile-detail-row">
                            <span>Phase</span>
                            <strong><?php echo e(optional($report->phase)->phase_name ?? 'Unassigned Phase'); ?></strong>
                        </div>
                        <div class="report-mobile-detail-row">
                            <span>Submitted By</span>
                            <strong><?php echo e(optional($report->submittedBy)->name ?? 'Supervisor'); ?></strong>
                        </div>
                    </div>

                    <div class="report-mobile-actions">
                        <button class="report-mobile-view js-report-view-btn" type="button" data-report-details='<?php echo json_encode($detailPayload, 15, 512) ?>' data-modal-target="reportDetailsModal-<?php echo e($report->report_id); ?>">
                            <i class="bi bi-eye"></i>
                            View Details
                        </button>
                        <a href="<?php echo e(route('client.reports.downloadPdf', $report->report_id)); ?>" target="_blank" data-report-id="<?php echo e($report->report_id); ?>" class="report-mobile-download report-export-link">
                            <i class="bi bi-download"></i>
                        </a>
                    </div>
                </article>
...
<div class="p-3 bg-light d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 border-top">
            <div class="small text-muted">Showing <?php echo e($reports->firstItem() ?? 0); ?> to <?php echo e($reports->lastItem() ?? 0); ?> of <?php echo e($reports->total()); ?> reports</div>
            <div><?php echo e($reports->appends(request()->only(['project_id', 'phase_id', 'status', 'report_date', 'sort']))->links('pagination::bootstrap-5')); ?></div>
        </div>
    </section>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\client\report.blade.php ENDPATH**/ ?>