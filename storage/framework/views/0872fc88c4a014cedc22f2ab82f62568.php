...
<div class="attendance-page">
    ...
    <section class="attendance-filter-card">
        ...
        <form method="GET" action="<?php echo e(route('admin.attendance.preview-report')); ?>" class="mt-3">
            <input type="hidden" name="date" value="<?php echo e($filters['date'] ?? now()->toDateString()); ?>">
            <input type="hidden" name="project_id" value="<?php echo e($filters['project_id'] ?? ''); ?>">
            <input type="hidden" name="status" value="<?php echo e($filters['status'] ?? ''); ?>">
            <input type="hidden" name="biometric" value="<?php echo e($filters['biometric'] ?? ''); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\admin\attendance.blade.php ENDPATH**/ ?>