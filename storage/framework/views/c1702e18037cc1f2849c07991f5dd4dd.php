<?php $__env->startSection('title', 'Phase Management - D&G Construction Monitor'); ?>
<?php $__env->startSection('page_title', 'Phase Management'); ?>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <label class="text-muted d-block uppercase tracking-wider mb-1" style="font-size: 10px; font-weight: 600; letter-spacing: 0.08em;">Select Project</label>
                     <select class="fw-semibold text-dark project-select" onchange="window.location='<?php echo e(route('admin.phases')); ?>?project_id='+this.value" style="width: auto; font-size: 13px;">
                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($projectOption->project_id); ?>" <?php echo e(($selectedProject && $selectedProject->project_id == $projectOption->project_id) ? 'selected' : ''); ?>>
                                <?php echo e($projectOption->project_name); ?>
            ...
            <div class="card h-100 bg-white metric-card p-3 shadow-sm">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 id="totalPhasesCount" class="mb-0 fw-bold text-dark"><?php echo e($stats['total']); ?></h3>
            ...
            <div class="card h-100 bg-white metric-card p-3 shadow-sm">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 id="inProgressPhasesCount" class="mb-0 fw-bold text-dark"><?php echo e($stats['in_progress']); ?></h3>
            ...
            <div class="card h-100 bg-white metric-card p-3 shadow-sm">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 id="completedPhasesCount" class="mb-0 fw-bold text-dark"><?php echo e($stats['completed']); ?></h3>
            ...
            <div class="card h-100 bg-white metric-card p-3 shadow-sm">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 id="pendingPhasesCount" class="mb-0 fw-bold text-dark"><?php echo e($stats['pending']); ?></h3>
            ...
            <div class="card h-100 bg-white metric-card p-3 shadow-sm">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 id="delayedPhasesCount" class="mb-0 fw-bold text-dark"><?php echo e($stats['delayed']); ?></h3>
                    ...
                    <table class="table table-hover align-middle mb-0 phase-table">
                        ...
                        <tbody id="phaseTableBody" style="font-size: 13px;">
                            <?php $__empty_1 = true; $__currentLoopData = $phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                ?>
                                <tr data-phase-row="true" data-phase-id="<?php echo e($phase->phase_id); ?>" data-phase-name="<?php echo e(strtolower($phase->phase_name)); ?>" data-phase-status="<?php echo e($phase->status); ?>" data-phase-progress="<?php echo e((float) ($phase->progress_percentage ?? 0)); ?>" data-phase-order="<?php echo e((int) $phase->phase_order); ?>" data-phase-title="<?php echo e(strtolower($phase->phase_name . ' ' . ($phase->project->project_name ?? ''))); ?>">
                                    <td class="ps-4 text-center">
                                        <div class="order-badge bg-forest-light text-forest-green mx-auto"><?php echo e($phase->phase_order); ?></div>
                                    </td>
                                    <td>
                                        <span class="phase-name-title d-block"><?php echo e($phase->phase_name); ?></span>
                                        <small class="phase-name-meta d-block text-truncate" style="max-width: 180px;"><?php echo e($phase->project->project_name ?? 'Project phase'); ?></small>
                                    </td>
                                    <td class="text-center">
                                        <div class="schedule-stack">
                                            <span class="schedule-chip"><i class="bi bi-calendar3 me-1"></i> <?php echo e($startDate); ?></span>
                                            <span class="schedule-separator"><i class="bi bi-arrow-right"></i></span>
                                            <span class="schedule-chip"><i class="bi bi-calendar3 me-1"></i> <?php echo e($endDate); ?></span>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center progress-cell">
                                            <div class="progress flex-grow-1" style="background-color: #f1f5f9; border-radius: 4px;">
                                                <div class="progress-bar <?php echo e($progressClass); ?>" style="width: <?php echo e(min(100, max(0, $progressValue))); ?>%;"></div>
                                            </div>
                                            <span class="progress-value"><?php echo e(number_format($progressValue, 0)); ?>%</span>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <span class="badge <?php echo e($statusClass); ?> px-2 py-1 rounded-pill fw-medium" style="font-size: 11px;"><?php echo e($statusLabel); ?></span>
                                        </div>
                                    </td>
                                    <td class="action-cell">
                                        <button class="btn btn-sm btn-light border p-1 text-primary rounded js-phase-edit-btn" type="button" title="Edit" data-phase-edit='<?php echo json_encode($detailPayload, 15, 512) ?>'><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-sm btn-light border p-1 text-success rounded js-phase-view-btn" type="button" title="View" data-phase-details='<?php echo json_encode($detailPayload, 15, 512) ?>'><i class="bi bi-eye"></i></button>
                                        <button class="btn btn-sm btn-light border p-1 text-danger rounded js-phase-delete-btn" type="button" title="Delete" data-phase-delete-url="<?php echo e(route('admin.phases.destroy', ['project' => $phase->project_id, 'phase' => $phase->phase_id])); ?>"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                ...
                <div class="card-footer bg-white border-top-0 py-3">
                    <div class="table-pagination-strip">
                        <div id="phaseResultsCount" class="pagination-summary">
                            Showing <?php echo e($phases->firstItem() ?? 0); ?> to <?php echo e($phases->lastItem() ?? 0); ?> of <?php echo e($phases->total()); ?> phase(s)
                        </div>
                        <div class="pagination-bar">
                            <a class="pagination-button <?php echo e($phases->onFirstPage() ? 'disabled' : ''); ?>" href="<?php echo e($phases->previousPageUrl() ?? '#'); ?>" aria-label="Previous page">‹</a>
                            <?php for($page = 1; $page <= $phases->lastPage(); $page++): ?>
                                <a class="pagination-button <?php echo e($page == $phases->currentPage() ? 'active' : ''); ?>" href="<?php echo e($phases->url($page)); ?>" aria-label="Page <?php echo e($page); ?>"><?php echo e($page); ?></a>
                            <?php endfor; ?>
                            <a class="pagination-button <?php echo e($phases->hasMorePages() ? '' : 'disabled'); ?>" href="<?php echo e($phases->nextPageUrl() ?? '#'); ?>" aria-label="Next page">›</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="phaseModal" tabindex="-1" aria-labelledby="phaseModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width: 620px;">
            <div class="modal-content border-0 shadow-lg rounded-4" style="background: #ffffff;">
                <form id="phaseForm" method="post" action="<?php echo e(route('admin.phases.store')); ?>" data-create-route="<?php echo e(route('admin.phases.store')); ?>" data-update-route-template="<?php echo e(route('admin.phases.update', ['project' => '__PROJECT__', 'phase' => '__PHASE__'])); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="_method" value="POST" id="phaseFormMethod">
                    <input type="hidden" name="project_id" value="<?php echo e(optional($selectedProject)->project_id ?? ''); ?>" id="projectIdInput">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="depends_on_phase_id" id="dependsOnPhaseInput" class="form-select px-3 shadow-none bg-white border" style="height: 44px; border-radius: 8px; font-size: 0.88rem;">
                                        ...
                                        <?php $__currentLoopData = (optional($selectedProject)->phases ?? collect())->sortBy('phase_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dependencyPhase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($dependencyPhase->phase_id); ?>">Phase <?php echo e($dependencyPhase->phase_order); ?>: <?php echo e($dependencyPhase->phase_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const phaseFlashSuccess = <?php echo json_encode(session('success'), 15, 512) ?>;
        const phaseFlashSuccessTitle = <?php echo json_encode(session('success_title'), 15, 512) ?>;
        const phaseFlashError = <?php echo json_encode($errors->first(), 15, 512) ?>;
        ...
        function applyPhaseFilters() {
            ...
            if (resultsCount) {
                const projectName = '<?php echo e(optional($selectedProject)->project_name ?? "this project"); ?>';
        ...
        const selectedProjectId = '<?php echo e(optional($selectedProject)->project_id ?? ""); ?>';
        const createPhaseUrl = phaseForm?.dataset.createRoute || '<?php echo e(route("admin.phases.store")); ?>';
        const updateRouteTemplate = phaseForm?.dataset.updateRouteTemplate || '<?php echo e(route("admin.phases.update", ["project" => "__PROJECT__", "phase" => "__PHASE__"])); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views/admin/phases.blade.php ENDPATH**/ ?>