            ...
            <tbody>
                ...
                <?php else: ?>
                    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-inline-flex gap-1">
                                    ...
                                    <button class="btn btn-sm download-report-btn" data-report-id="<?php echo e($report->report_id); ?>" style="background: white; color: var(--cms-green-dark); transition: all 0.2s ease;" onmouseover="this.style.color='var(--cms-green-dark)'; this.style.transform='scale(1.2)';" onmouseout="this.style.color='var(--cms-green-dark)'; this.style.transform='scale(1)';">
                        ...
                        ?>
                        <div class="modal fade report-details-modal" id="reportDetailsModal-<?php echo e($report->report_id); ?>" data-gallery='<?php echo json_encode($siteImageUrls->map(fn($url) => $url)->values(), 15, 512) ?>' tabindex="-1" aria-labelledby="reportDetailsModalLabel-<?php echo e($report->report_id); ?>" aria-hidden="true">
                                        ...
                                        <div class="row gx-4 gy-4">
                                                ...
                                                <div class="report-detail-card p-4">
                                                    ...
                                                    <div class="row g-3 mb-4 small">
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            ...
                                                            <div class="text-dark"><?php echo e(optional($report->project)->project_name ?? 'N/A'); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            <div class="fw-semibold text-muted mb-1">Construction Phase</div>
                                                            <div class="text-dark"><?php echo e(optional($report->phase)->phase_name ?? 'N/A'); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                            <div class="fw-semibold text-muted mb-1">Report Date</div>
                                                            <div class="text-dark"><?php echo e(optional($report->report_date)->format('M d, Y h:i A') ?? 'N/A'); ?></div>
                                                        </div>
                                                        <div class="col-12 col-sm-6 p-3 rounded" style="background: #f9fafb;">
                                                    ...
                                                    <div class="p-4 rounded-3 mb-4" style="white-space: pre-line; line-height: 1.7; background: #f9fafb;">
                                                        ...
                                                        <p class="mb-0 text-dark small"><?php echo e($report->report_text ?? 'No description logs reported.'); ?></p>
                                                    </div>
                                            ...
                                            <div class="col-12 col-xl-5">
                                                <div class="report-detail-sidebar p-4">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="d-flex flex-wrap gap-2 mb-4">
                                                            <?php $__currentLoopData = $siteImageUrls->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($siteImageUrls->count() > 4): ?>
                                                                <button type="button" class="more-images-badge lightbox-trigger d-flex align-items-center justify-content-center" style="background: #f9fafb; border: 2px solid #e5e7eb; color: #6b7280;" data-full-image="<?php echo e($siteImageUrls->skip(4)->first()); ?>" data-gallery='<?php echo json_encode($siteImageUrls->map(fn($url) => $url)->values(), 15, 512) ?>' aria-label="View all site images">+<?php echo e($siteImageUrls->count() - 4); ?> more</button>
                                                            <?php endif; ?>
                                                        </div>
                                                    <?php endif; ?>
                                                ...
                                                <div class="d-flex justify-content-center" style="padding-top: 2rem; margin-top: 2rem; border-top: 2px solid var(--cms-green-muted);">
                                                    <button class="btn btn-cms-primary download-report-btn" data-report-id="<?php echo e($report->report_id); ?>">
                    ...
                    <div class="row">
                            ...
                            <select name="project_id" id="modal_project_id" class="form-select cms-form-control" required>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $assignedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($project->project_id); ?>" <?php echo e(optional($modalProject ?? $selectedProject)->project_id == $project->project_id ? 'selected' : ''); ?>><?php echo e($project->project_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
                        <div class="col-12 col-md-6 cms-form-group">
                            ...
                            <select name="phase_id" id="modal_phase_id" class="form-select cms-form-control" required>
                                ...
                                <?php $__currentLoopData = $projectPhases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($phase->phase_id); ?>" data-completion-percentage="<?php echo e($phase->completion_percentage ?? 0); ?>"><?php echo e($phase->phase_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.supervisor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Paul Pastor\DGConstruction\resources\views\supervisor\reports\index.blade.php ENDPATH**/ ?>