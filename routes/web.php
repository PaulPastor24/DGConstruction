...
Route::middleware(['auth', 'role:engineer'])->group(function () {
    ...
    Route::post('/admin/phases', [PhaseController::class, 'store'])->name('admin.phases.store');
    Route::put('/admin/projects/{project}/phases/{phase}', [PhaseController::class, 'update'])->name('admin.phases.update');
    Route::delete('/admin/projects/{project}/phases/{phase}', [PhaseController::class, 'destroy'])->name('admin.phases.destroy');
    ...
    Route::post('/admin/inventory/materials/{material}/receive', [AdminDashboardController::class, 'receiveStock'])->name('admin.inventory.materials.receive');
...
Route::middleware(['auth', 'role:supervisor'])->group(function () {
    ...
    Route::post('/supervisor/workers/register-biometric', [BiometricController::class, 'registerWorkerBiometric'])
