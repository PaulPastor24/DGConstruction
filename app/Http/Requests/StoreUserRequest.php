...
class StoreUserRequest extends FormRequest
{
    ...
    /**
     * Normalize input before validation runs, so validation (and the
     * data that eventually gets saved) is always working with clean,
     * consistent values rather than whatever raw whitespace/casing the
    ...
    public function rules(): array
    {
        return [
            'first_name' => [
                ...
                // e.g. "Ma. Jose", "Dela Cruz-Santos", "D'Angelo"
                'regex:/^[\pL\s\'\-\.]+$/u',
            ],
            'last_name' => [
                'required',
